...
class Pemeriksaan extends _adminController
{
	...
	protected function init()
	{
		...
		$this->data['unitarr'] = $this->modelunit->GetCombo(true);
		// dpr($this->data['unitarr'],1);
	...
	public function Index($jenis = null, $page = 0)
	{
		...
		if (!$this->Access("view_all", "main")) {
			...
			or exists (select 1 from pemeriksaan_temuan_saran pts where 
			b.id_pemeriksaan_temuan = pts.id_pemeriksaan_temuan
			and pts.id_jabatan = " . $this->conn->escape($_SESSION[SESSION_APP]['id_jabatan']) . "))";
		}
...
FROM
	...
	private function _filter()
	{
		...
		$this->data['unitarr'] = $this->mtsdmunit->GetCombo(true);
