...
class Penilaian_gcg extends Penilaian
{
	...
	protected function init()
	{
		...
		$this->viewadd = "gcg";
		$this->viewprint = 'panelbackend/penilaianprintgcg';
		$this->load->model("Penilaian_periodeModel", "model");
		// $this->load->model("Mt_kriteriaModel", "mkriteria");
		$this->load->model("Penilaian_sessionModel", "modelPenilaianSession");
		$this->data['penilaiansessionarr'] = $this->modelPenilaianSession->GetCombo();
