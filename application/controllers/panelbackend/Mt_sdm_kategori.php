...
class Mt_sdm_kategori extends _adminController{
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/mt_sdm_kategorilist";
		$this->viewdetail = "panelbackend/mt_sdm_kategoridetail";
		...
		$this->load->model("Mt_sdm_kategoriModel","model");
	...
	protected function Rules(){
		return array(
			"code"=>array(
				'field'=>'code', 
				'label'=>'Code', 
				'rules'=>"required|is_unique[mt_sdm_kategori.code]|max_length[20]",
			),
			"nama"=>array(
				'field'=>'nama', 
				'label'=>'Nama', 
