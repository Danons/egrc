...
class Mt_kategori extends _adminController{
	public $limit = -1;
	...
	protected function init(){
		parent::init();
		$this->viewlist = "panelbackend/mt_kategorilist";
		...
		$this->load->model("Mt_periodeModel","mtperiode");
		$this->data['mtperiodearr'] = $this->mtperiode->GetCombo();
	...
	public function Detail( $id=null){
		...
		/*if($this->data['row']['id_kategori_jenis'] == 1)
			redirect("panelbackend/mt_kriteria_smk3/index/".$id);
		if($this->data['row']['id_kategori_jenis'] == 2)*/
			redirect("panelbackend/mt_kriteria/index/".$id);
		/*if($this->data['row']['id_kategori_jenis'] == 3)
			redirect("panelbackend/mt_kriteria_proper/index/".$id);*/
	...
	protected function Record($id=null){
		return array(
			...
			'periode_penilaian'=>($this->post['periode_penilaian']),
		);
	}
