    ...
    public function Add($page = null)
    {
        ...
        switch ($page) {
            ...
            case 'kpi_unit_kerja':
                ...
                break;
            case 'kontrak_kinerja_direksi':
                $this->data['page_title'] = "Kontrak Kinerja Direksi";
                break;
            case 'kontrak_kinerja_dewan_pengawas':
                $this->data['page_title'] = "Kontrak Kinerja Dewan Pegawas";
                break;
            default:
...
*/
    ...
    protected function _afterDetail($id, $page = null)
    {
        ...
        $this->data['page_title'] .= UI::createSelect("periode", $this->data['periodearr'], $id, true, '', "style='width:150px; margin-left:10px;' onchange='goSubmit(\"set_periode\")'");
