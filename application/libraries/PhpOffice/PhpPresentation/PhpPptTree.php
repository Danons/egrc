...
class PhpPptTree
{
    ...
    {
        // return $this->displayPhpPresentationInfo1($this->oPhpPresentation);
        $this->displayPhpPresentationInfo1($this->oPhpPresentation);
    }
    protected function displayPhpPresentationInfo1(PhpPresentation $oPHPPpt)
    {
            ...
            foreach ($oSlide->getShapeCollection() as $oShape) {
                if ($oShape instanceof Group) {
                    foreach ($oShape->getShapeCollection() as $oShapeChild) {
                        $this->displayShapeInfo1($oShapeChild);
                    }
                } else {
                    $this->displayShapeInfo1($oShape);
                }
            }
        }
    }
    protected function displayShapeInfo1(AbstractShape $oShape)
    {
