...
<div id="layout1" class="tr-layout1-public_sys_user container-fluid content <?php if ($_SESSION[SESSION_APP]['toggle'] || !$sidebarmenu) { ?> minimized <?php } else { ?> expanded <?php } ?>">
    <div class="row">
        <?php
        if ($sidebarmenu) { ?>
