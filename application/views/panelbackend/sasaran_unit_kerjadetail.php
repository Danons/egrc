<div class="row">
    ...
    <?php
      ...
      ?>
        ...
        <?php
        $from = UI::createSelect('id_unit', $unitarr, $row['id_unit'], $edited, $class = 'form-control ', 'style="width:100%;" onchange="goSubmit(\'set_value\')" ');
        echo UI::createFormGroup($from, $rules["id_unit"], "id_unit", "Unit", false, 2, $edited);
        ?>
