<div id="container" class="container " <?= ($width_page ? "style='max-width:$width_page'" : "") ?>>
    <center>
        <div class="notshow">
            ...
            <?php if ($download) { ?>
                <!-- <a class="btn btn-sm btn-primary" onclick="exportDocxFile()">
                    <span class="bi bi-printer"></span>
                    download
                </a> -->
                <a class="btn btn-sm btn-primary" href="<?= base_url('panelbackend/spi_audit_evaluasi/go_print/' . $row['id_audit_evaluasi']) ?>">
                    <span class="bi bi-printer"></span>
                    download
                </a>
            <?php } ?>
