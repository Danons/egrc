<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th rowspan="2">ASPEK PENGUJIAN / INDIKATOR</th>
            <th rowspan="2" style="text-align: center;">JUMLAH PARAMETER</th>
            <th rowspan="2" style="text-align: center;">BOBOT INDIKATOR</th>
            <th colspan="2" style="text-align: center;">CAPAIAN <?= $tahun ?></th>
        </tr>
        <tr>
    ...
    <tbody>
        ...
        ?>
            <?php if ($r['kode_aspek'] <> $kode_aspek) {
                $no = 1; ?>
                <tr>
                    <td><b><?= $r['kode_aspek'] ?></b></td>
                    <td colspan="5"><b><?= $r['aspek'] ?></b></td>
                </tr>
            <?php } ?>
            <tr>
                <td><?= $r['kode_indikator'] ?></td>
                <td><?= $r['indikator'] ?></td>
                <td style="text-align: center;"><?= rupiah($r['jumlah_paramater']) ?></td>
        ...
        <tr>
            ...
            <td style="text-align: center;"><?php echo round($total_skor_bobot / $total_bobot * 100, 2) ?></td>
        </tr>
    </tbody>
</table>