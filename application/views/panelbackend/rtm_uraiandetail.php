<div class="row">
    <div class="col-sm-12">
        <b style="display: flex;">
            RTM KE &nbsp;&nbsp;<?= UI::createSelect('id_rtm', $rtmarr, $row['id_rtm'], $edited, '', "style='width:100px;' onchange='goSubmit(\"set_value\")'"); ?>
        </b>
        <br />
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                if (Access("evaluasi", "panelbackend/rtm_risalah")) {
                    $from = UI::createRadio("status", ["0" => "Open", "1" => "Close"], $row['status'], $edited);
    ...
    <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
        <div class="row">
            <div class="col-sm-12">
                ...
                $from = "<table width='100%'><thead><tr><th>Target</th><th>Realisasi</th><th>Kompetitor</th><th>Tahun</th></tr></thead>" . UI::AddFormTable('progress', $row['progress'],  $from, $edited, $this) . "</table>";
