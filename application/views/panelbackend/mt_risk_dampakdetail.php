<div class="col-sm-6">
    ...
    <?php
    // $from = UI::createTextBox('nama_peluang', $row['nama_peluang'], '300', '100', $edited, $class = 'form-control ', "style='width:100%'");
    // echo UI::createFormGroup($from, $rules["nama_peluang"], "nama_peluang", "Dampak Peluang");
    ?>
