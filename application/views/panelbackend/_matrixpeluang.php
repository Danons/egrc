                    ...
                    foreach ($rs_dampak as $r_d => $val_d) {
                        ...
                        if ($top_inheren[$val_d['id_dampak']][$val_k['id_kemungkinan']] && $ratingpeluang['i']) {
                            foreach ($top_inheren[$val_d['id_dampak']][$val_k['id_kemungkinan']] as $n) {
                                ...
                                // $d = "<div title='" . $noarr[$n]['nama'] . "' class='$cee bg333'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                if ($nokotak > $maxdot)
                                    $div1 .= "<div class='$cee bg333'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n " . $noarr[$n]['nama'] . "</a></div>";
                                else
                                    $div .= "<div data-bs-toggle='tooltip' title='" . $noarr[$n]['nama'] . "' class='$cee bg333'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                // $div .= $d;
                            }
                        }
                        if ($top_paska_kontrol[$val_d['id_dampak']][$val_k['id_kemungkinan']] && $ratingpeluang['c']) {
                            foreach ($top_paska_kontrol[$val_d['id_dampak']][$val_k['id_kemungkinan']] as $n) {
                                ...
                                // $d = "<div title='" . $noarr[$n]['nama'] . "' class='$cee bg666'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                if ($nokotak > $maxdot)
                                    $div1 .= "<div class='$cee bgfff'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n  " . $noarr[$n]['nama'] . "</a></div>";
                                else
                                    $div .= "<div data-bs-toggle='tooltip' title='" . $noarr[$n]['nama'] . "' class='$cee bg666'><a href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                // $div .= $d;
                            }
                        }
                        if ($top_actual[$val_d['id_dampak']][$val_k['id_kemungkinan']] && $ratingpeluang['a']) {
                            foreach ($top_actual[$val_d['id_dampak']][$val_k['id_kemungkinan']] as $n) {
                                ...
                                // $d = "<div title='" . $noarr[$n]['nama'] . "' class='$cee bgfff'><a style='font-weight:bold;' href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                if ($nokotak > $maxdot)
                                    $div1 .= "<div class='$cee bgfff'><a style='font-weight:bold;' href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n " . $noarr[$n]['nama'] . "</a></div>";
                                else
                                    $div .= "<div data-bs-toggle='tooltip'  title='" . $noarr[$n]['nama'] . "' class='$cee bgfff'><a style='font-weight:bold;' href='" . site_url("panelbackend/opp_peluang/detail/" . $noarr[$n]['id_scorecard'] . "/" . $noarr[$n]['id_peluang']) . "' target='_BLANK'>$n</a></div>";
                                // $div .= $d;
                            }
                        }

                        echo "<td class='bg-$bg' style='border:1px solid #555;background-color:$bg; padding:1px;$css' height='75px' width='75px' align='center' valign='middle'><div style='position:relative;height:75px;width:75px; vertical-align:middle; text-align:center;padding:0px 0px;'>$tingkat_peluang
