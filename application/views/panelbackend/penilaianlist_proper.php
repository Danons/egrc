        ...
        ?>
                <tr>
                   ...
                   <!--  <td>
                    ...
                    <?php } ?>  
                    <?php if(!($status1!=='' && $status1!==null)){  $nilai_proper = $r1['nilai_proper']; $total_nilaiarr[] = (float)$r1['nilai_sub_area']; ?>
                        <td rowspan="<?= $r1['rowspan'] ?>" style="background: <?=$background[trim(strtolower($nilai_proper['kode']))]?> !important; color: #fff !important">
                            <?=nl2br($nilai_proper['nama'])?>
                        </td>
                    <?php } ?>
                </tr>
            <?php 
