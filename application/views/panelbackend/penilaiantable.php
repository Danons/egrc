<table class="table table-sticky table-bordered">
    <thead>
        <tr>
            ...
            <?php if ($penilaiansessionsebelumnya) {
                echo " <th rowspan='2'>Nilai Sebelumnya</th>";
            } ?>
            <th rowspan="2">Nilai</th>
            <?php if ($id_kategori_jenis == 1) { ?>
                <th rowspan="2">Skor</th>
            <?php } ?>
            <th width="4px" rowspan="2">Diuji/Tidak</th>
            <th rowspan="2">Area Of Improvement</th>
        </tr>
        <tr>
            <th>D</th>
            <th>K</th>
    ...
    <tbody>
        ...
        // dpr($arearr,1);
        function print_table($arearr, $level = 0, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya = null)
        {
            $level++;
                ...
                switch ($level) {
                    case 1:
                        ...
                        if (!$r2['sub3']) {
                            ...
                            if ($r2['skor_sebelumnya']['skor_sebelumnya'] != '' && $penilaiansessionsebelumnya) {
                                echo "<td rowspan='" . $r2['rowspan'] . "' style='text-align:center;cursor:pointer;background:" . warnaskor($r2['skor_sebelumnya']['skor_sebelumnya']) . ";' onclick='detail(" . $r2['id_penilaian_periode'], ',' . $r2['id_kriteria'] . ")'>" . $r2['skor_sebelumnya']['skor_sebelumnya'] . "</td>";
                            } elseif ($penilaiansessionsebelumnya) {
                                echo "<td></td>";
                            } else {
                                echo "";
                            }
                        ...
                        if ($r2['sub3']) {
                            ...
                            if ($r3['skor_sebelumnya']['skor_sebelumnya'] != '' && $penilaiansessionsebelumnya) {
                                echo "<td rowspan='" . $r3['rowspan'] . "' style='text-align:center;cursor:pointer;background:" . warnaskor($r3['skor_sebelumnya']['skor_sebelumnya']) . ";' onclick='detail(" . $r3['id_penilaian_periode'], ',' . $r3['id_kriteria'] . ")'>" . $r3['skor_sebelumnya']['skor_sebelumnya'] . "</td>";
                            } elseif ($penilaiansessionsebelumnya) {
                                echo "<td></td>";
                            } else {
                                echo "";
                        ...
                        if ($r2['sub3'])
                            print_table($r2['sub3'], 3, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya);

                        if ($r1['sub2'])
                            print_table($r1['sub2'], 2, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya);

                        if ($r['sub1'])
                            print_table($r['sub1'], 1, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya);
                    ...
                    case 2:
                        ...
                        if ($r['sub2'])
                            print_table($r['sub2'], 2, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya);
                        break;
                    case 3:
                        echo "<tr>";
                        ...
                        if (!$r['sub3']) {
                            ...
                            if ($r['skor_sebelumnya']['skor_sebelumnya'] != '' && $penilaiansessionsebelumnya) {
                                echo "<td rowspan='" . $r['rowspan'] . "' style='text-align:center;cursor:pointer;background:" . warnaskor($r['skor_sebelumnya']['skor_sebelumnya']) . ";' onclick='detail(" . $r['id_penilaian_periode'], ',' . $r['id_kriteria'] . ")'>" . $r['skor_sebelumnya']['skor_sebelumnya'] . "</td>";
                            } elseif ($penilaiansessionsebelumnya) {
                                echo "<td></td>";
                            } else {
                                echo "";
                        ...
                        if ($r['sub3'])
                            print_table($r['sub3'], 3, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya);
                        break;
                    case 4:
                        echo "<tr>";
        ...
        print_table($arearr, 0, $id_kategori_jenis, $is_admin, $penilaiansessionsebelumnya); ?>
    </tbody>
</table>