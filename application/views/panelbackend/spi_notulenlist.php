    ...
    <tbody>
        ...
        foreach ($list['rows'] as $rows) {
            ...
            foreach ($header as $rows1) {
                // $acara .= $acaraarr[$rows['id_notulen']];
                $val = $rows[$rows1['name']];
                ...
                } elseif ($rows1['name'] == 'acara') {
                    echo "<td>" .   $resultAcaraArr[$rows['id_notulen']] . "<br>" . "</td>";
                } elseif ($rows1['name'] == 'id_peserta') {
                    echo "<td>" .   $resultPesertaArr[$rows['id_notulen']] . "<br>" . "</td>";
                } else {
                    switch ($rows1['type']) {
                        case 'list':
