<table class="table table-bordered">
    <thead>
        <tr>
            ...
            <th rowspan="2">PARAMETER ASSESSMENT GCG</th>
            <th rowspan="2" style="text-align: center;">BOBOT PAR</th>
            <th colspan="2" style="text-align: center;">HASIL ASSESSMENT</th>
        </tr>
        <tr>
        ...
        ?>
            <?php if ($r['kode_aspek'] <> $kode_aspek) {
                ...
                <tr>
                    ...
                    <td colspan="4"><b><?= $r['aspek'] ?></b></td>
                </tr>
            <?php } ?>
            <tr>
                <td><?= $r['kode_paramater'] ?></td>
                <td><?= $r['paramater'] ?></td>
