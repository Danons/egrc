    ...
    <tbody>
        ...
        ?>
                <td align="center">
                    ...
                    <?php if ($row['is_aktif_penilaian']) {
                        echo '<p style="margin:0px; font-size:20px;">☑</p>';
                    } ?>
                ...
                switch ($level) {
                    case 1:
                        ...
                        if (!$r2['sub3']) {
                            ...
                            echo "<td style='text-align:center;' rowspan='" . $r2['rowspan'] . "'>";
                            echo checkbox($r2['d']);
                            echo "</td>";
                        ...
                        if ($r2['sub3']) {
                            ...
                            echo "<td style='text-align:center;' rowspan='" . $r3['rowspan'] . "'>";
                            echo checkbox($r3['d']);
                            echo "</td>";
                    ...
                    case 3:
                        ...
                        if (!$r['sub3']) {
                            ...
                            echo "<td style='text-align:center;' rowspan='" . $r['rowspan'] . "'>";
                            echo checkbox($r['d']);
                            echo "</td>";
