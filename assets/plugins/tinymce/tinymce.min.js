...
!(function () {
  ...
  var qo = (e, t, n, o, r) => (e(n, o) ? M.some(n) : w(r) && r(n) ? M.none() : t(n, o, r));
  const Wo = (e, t, n) => {
    let o = e.dom;
    const r = w(n) ? n : P;
    for (; o.parentNode;) {
      ...
      const o = {},
        ...
        i = (i) =>
          new Promise((l, d) => {
            ...
            const v = Date.now();
            var y;
            t.contentCssCors && Vt(b, 'crossOrigin', 'anonymous'), t.referrerPolicy && Vt(b, 'referrerpolicy', t.referrerPolicy), (c = b.dom), (c.onload = h), (c.onerror = p), (y = b), Jn(Mn(r), y), Vt(b, 'href', u);
          }),
        l = (e) => {
  ...
  const er = ['pre'].concat(['h1', 'h2', 'h3', 'h4', 'h5', 'h6']),
    ...
    or = (e) => Ft(e) && !nr(e),
    rr = (e) => Ft(e) && 'br' === Lt(e),
    sr = tr(['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'div', 'address', 'pre', 'form', 'blockquote', 'center', 'dir', 'fieldset', 'header', 'footer', 'article', 'section', 'hgroup', 'aside', 'nav', 'figure']),
    ar = tr(['ul', 'ol', 'dl']),
    ir = tr(['li', 'dd', 'dt']),
    ...
    Rr = yo,
    Ar = Ro,
    Or = (e) => (Ar(e) && (e = e.parentNode), Rr(e) && e.hasAttribute('data-mce-caret')),
    Tr = (e) => Ar(e) && Er(e.data),
    Br = (e) => Or(e) || Tr(e),
    Dr = (e) => e.firstChild !== e.lastChild || !Po(e.firstChild),
    Pr = (e) => {
      const t = e.container();
      return !!Ro(t) && (t.data.charAt(e.offset()) === _r || (e.isAtStart() && Tr(t.previousSibling)));
    },
    Lr = (e) => {
      const t = e.container();
      return !!Ro(t) && (t.data.charAt(e.offset() - 1) === _r || (e.isAtEnd() && Tr(t.nextSibling)));
    },
      ...
      e && e.hasAttribute('data-mce-caret')
        ? (((e) => {
          ...
          const n = e.getElementsByTagName('br'),
            o = n[n.length - 1];
          So(o) && (null === (t = o.parentNode) || void 0 === t || t.removeChild(o));
        })(e),
    ...
    qr = wo(['img', 'input', 'textarea', 'hr', 'iframe', 'video', 'audio', 'object', 'embed']),
    Wr = wo(['table']),
    Kr = Br,
    Gr = (e) => !Kr(e) && ($r(e) ? !Vr(e.parentNode) : qr(e) || Hr(e) || Wr(e) || Yr(e)),
    Yr = (e) => !((e) => yo(e) && 'true' === e.getAttribute('unselectable'))(e) && jr(e),
    Xr = (e, t) =>
      Gr(e) &&
      ((e, t) => {
        ...
        a = Y(
          ...
          (e, t) =>
            ((e) => -1 !== ' \f\t\v'.indexOf(e))(t) || t === pr
              ? e.pcIsSpace || ('' === e.str && n) || (e.str.length === s.length - 1 && o) || ((e, t) => t < e.length && t >= 0 && Zr(e[t]))(s, e.str.length + 1)
    ...
    ts = (e, t) =>
      ...
      ((e) => yo(e) && 'A' === e.nodeName && !e.hasAttribute('href') && (e.hasAttribute('name') || e.hasAttribute('id')))(e) ||
      ns(e),
    ns = ko('data-mce-bookmark'),
    os = ko('data-mce-bogus'),
    rs = ('data-mce-bogus', 'all', (e) => yo(e) && 'all' === e.getAttribute('data-mce-bogus'));
  const ss = (e, t = !0) =>
    ((e, t) => {
      let n = 0;
      if (ts(e, e)) return !1;
    ...
    is = (e) => ((e) => 'span' === e.nodeName.toLowerCase())(e) && 'bookmark' === e.getAttribute('data-mce-type'),
    ls = (e, t, n) => {
      var o;
      const r = n || t;
      ...
      if (yo(t)) {
        ...
        1 === e.length && is(e[0]) && (null === (o = t.parentNode) || void 0 === o || o.insertBefore(e[0], t));
      }
      return (
        ((e) => Do(e) || Bo(e))(t) ||
        ts(t, r) ||
    ...
    Cs = (e, t) => e.replace(t ? cs : us, (e) => (e.length > 1 ? '&#' + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ';' : ps[e] || '&#' + e.charCodeAt(0) + ';')),
    ws = (e, t, n) => {
      const o = n || vs;
    ...
    xs = {
      ...
      getEncodeFunc: (e, t) => {
        ...
        return o.named && o.numeric
          ? (e, t) => e.replace(t ? cs : us, (e) => (void 0 !== ps[e] ? ps[e] : void 0 !== n[e] ? n[e] : e.length > 1 ? '&#' + (1024 * (e.charCodeAt(0) - 55296) + (e.charCodeAt(1) - 56320) + 65536) + ';' : '&#' + e.charCodeAt(0) + ';'))
          : o.named
            ? t
              ? (e, t) => ws(e, t, n)
              : ws
    ...
    Ds = (e) => Bs('td th li dt dd figcaption caption details summary', e.getTextBlockElements()),
    Ps = (e, t) => {
      if (e) {
        const n = {};
        return (
          m(e) && (e = { '*': e }),
          Ns(e, (e, o) => {
            n[o] = n[o.toUpperCase()] = 'map' === t ? Es(e, /[, ]/) : As(e, /[, ]/);
          }),
          n
        );
      }
    ...
    Ls = (e = {}) => {
      ...
      const s = {},
        ...
        d = ((e) => {
          ...
          const a = (e, o = '', r = '') => {
            ...
            for (; i--;) {
              const e = Ts([n, o].join(' '));
              t[a[i]] = { attributes: re(e, () => ({})), attributesOrder: e, children: re(s, N(_s)) };
            }
          },
            i = (e, n) => {
              const o = Ts(e),
          ...
          return (
            ...
            'html4' !== e &&
            (i('input button select textarea', 'autofocus'), i('input textarea', 'placeholder'), i('a', 'download'), i('link script img', 'crossorigin'), i('img', 'loading'), i('iframe', 'sandbox seamless allow allowfullscreen loading')),
            'html4' !== e &&
            V([t.video, t.audio], (e) => {
      ...
      Ns('script noscript iframe noframes noembed title style textarea xmp plaintext'.split(' '), (e) => {
        a[e] = new RegExp('</' + e + '[^>]*>', 'gi');
      });
                ...
                if (
                  ...
                  for (let t = 0, n = e.length; t < n; t++)
                    if (((d = o.exec(e[t])), d)) {
                      ...
                      if (
                        (o &&
                          ('=' === o && ((f.attributesDefault = f.attributesDefault || []), f.attributesDefault.push({ name: n, value: r }), (e.defaultValue = r)),
                            '~' === o && ((f.attributesForced = f.attributesForced || []), f.attributesForced.push({ name: n, value: r }), (e.forcedValue = r)),
                            '<' === o && (e.validValues = Es(r, '?'))),
                          s.test(n))
                      ) {
                        const t = e;
                        (f.attributePatterns = f.attributePatterns || []), (t.pattern = k(n)), f.attributePatterns.push(t);
              ...
              Ns(Ts(e, ','), (e) => {
                ...
                if (r) {
                  ...
                  if (((o[a] = o[t]), (s[a] = t), (v[a.toUpperCase()] = {}), (v[a] = {}), e || ((w[a.toUpperCase()] = {}), (w[a] = {})), !n[a])) {
                    let e = n[t];
                    (e = Rs({}, e)), delete e.removeEmptyAttrs, delete e.removeEmpty, (n[a] = e);
                  }
                  Ns(o, (e, n) => {
      ...
      e.valid_elements
        ...
        : (Ns(d, (e, t) => {
          ...
          Ns(Ts('p h1 h2 h3 h4 h5 h6 th td pre div address caption li'), (e) => {
            n[e].paddEmpty = !0;
          }),
          Ns(Ts('span'), (e) => {
        ...
        R('+ol[ul|ol],+ul[ul|ol]'),
        Ns({ dd: 'dl', dt: 'dl', li: 'ul ol', td: 'tr', th: 'tr', tr: 'tbody thead tfoot', tbody: 'table', thead: 'table', tfoot: 'table', legend: 'fieldset', area: 'map', param: 'video audio object' }, (e, t) => {
        ...
        parse: (t) => {
          ...
          if (t) {
            ...
            u('border', '', !0),
              ...
              (y = 'border-style'),
              (C = 'border-color'),
              m((v = 'border-width')) && m(y) && m(C) && ((a.border = a[v] + ' ' + a[y] + ' ' + a[C]), delete a[v], delete a[y], delete a[C]),
    ...
    Is = { keyLocation: !0, layerX: !0, layerY: !0, returnValue: !0, webkitMovementX: !0, webkitMovementY: !0, keyIdentifier: !0, mozPressure: !0 },
    Fs = (e, t) => {
      const n = null != t ? t : {};
    ...
    Vs = (e, t, n) => {
      ...
      const s = () => {
        Hs(e, 'DOMContentLoaded', s), Hs(e, 'load', s), n.domLoaded || ((n.domLoaded = !0), t(r)), (e = null);
      };
          ...
          r.domLoaded && 'ready' === t && 'complete' === e.readyState
            ...
            : (r.hasFocusIn ||
              ...
              s
                ...
                : ((r.events[l][t] = s = [{ func: n, scope: o }]), (s.fakeName = f), (s.capture = m), (s.nativeHandler = u), 'ready' === t ? Vs(e, u, r) : js(e, f || t, u, m)));
      }
      return (e = s = null), n;
    }
    unbind(e, t, n) {
        ...
        if (t) {
          ...
          for (; s--;) {
            ...
            if (a) {
              ...
              (n && 0 !== a.length) || (delete r[t], Hs(e, a.fakeName || t, a.nativeHandler, a.capture));
            }
          }
        } else
          fe(r, (t, n) => {
  ...
  const Ws = Tt.each,
    Ks = Tt.grep,
    Gs = 'data-mce-style',
    Ys = Tt.makeMap('fill-opacity font-weight line-height opacity orphans widows z-index zoom', ' '),
    Xs = (e, t, n) => {
    ...
    ea = (e, t, n) => {
      const o = Qs(t);
      y(n) || '' === n ? Gn(e, o) : Hn(e, o, ((e, t) => (x(e) ? (xe(Ys, t) ? e + '' : e + 'px') : e))(n, o));
    },
    ta = (e, t = {}) => {
      const n = {},
        o = window,
        r = {};
      let s = 0;
      const a = Jo.forElement(mn(e), { contentCssCors: t.contentCssCors, referrerPolicy: t.referrerPolicy }),
        i = [],
        l = t.schema ? t.schema : Ls({}),
        d = Ms({ url_converter: t.url_converter, url_converter_scope: t.url_converter_scope }, t.schema),
          ...
          T(e, (e) => {
            if (yo(e)) {
              const r = mn(e),
                ...
                a = Wt(r, n),
                i = Y[n];
              i && i.set ? i.set(r.dom, s, n) : Xs(r, n, s), a !== s && t.onSetAttrib && t.onSetAttrib({ attrElm: r.dom, attrName: n, attrValue: s });
            }
          });
        },
        ...
        k = (t, n) =>
          ((e, t, n) => {
            ...
            if (((n = n || e), t)) {
              if (n === e && t.getBoundingClientRect && 'static' === Vn(mn(e), 'position')) {
        ...
        _ = (e, t, n) => {
          const o = f(e);
          if (!y(o) && yo(o)) return n ? Vn(mn(o), Qs(t)) : ('float' === (t = t.replace(/-(\D)/g, (e, t) => t.toUpperCase())) && (t = 'cssFloat'), o.style ? o.style[t] : void 0);
        },
        E = (e) => {
          const t = f(e);
          if (!t) return { w: 0, h: 0 };
          ...
          isEmpty: (e, t) => {
            ...
            if (o) {
              ...
              do {
                ...
                if (Ro(i) && i.parentNode && s[i.parentNode.nodeName] && Jr(i.data)) return !1;
                i = r.next();
              } while (i);
            }
            return n <= 1;
        ...
        Y = ((e, t, n) => {
          const o = t.keep_values,
            r = {
              set: (e, o, r) => {
                const s = mn(e);
                w(t.url_converter) && C(o) && (o = t.url_converter.call(t.url_converter_scope || n(), String(o), r, e)), Xs(s, 'data-mce-' + r, o), Xs(s, r, o);
              },
              get: (e, t) => {
                const n = mn(e);
  ...
  const ra = (e) => {
    ...
    da = () => {
      const e = [],
        ...
        a = (e, n) => {
          const o = la.getCode();
          !o || (n && -1 === (',' + (n || '') + ',').indexOf(',' + o + ',')) || oa.ScriptLoader.add(t[e] + '/langs/' + o + '.js');
        },
        i = (e, t = 'added') =>
      ...
      return {
        ...
        requireLangPack: (e, t) => {
          !1 !== da.languageLoad && (s(e) ? a(e, t) : i(e, 'loaded').then(() => a(e, t)));
        },
        ...
        load: (e, o) => {
          ...
          0 !== s.indexOf('/') && -1 === s.indexOf('://') && (s = da.baseURL + '/' + s), (t[e] = s.substring(0, s.lastIndexOf('/')));
  ...
  (da.languageLoad = !0), (da.baseURL = ''), (da.PluginManager = da()), (da.ThemeManager = da()), (da.ModelManager = da());
  const ca = (e) => {
    const t = ra(M.none()),
    ...
    xa = (e, t) => Gt(e, 'data-mce-bogus') || fr(e, '[data-mce-bogus="all"]', Ca(t)),
    ka = (e, t) => {
  ...
  const Ea = (e) => {
    ...
    Ba = Math.round,
    Da = (e) => (e ? { left: Ba(e.left), top: Ba(e.top), bottom: Ba(e.bottom), right: Ba(e.right), width: Ba(e.width), height: Ba(e.height) } : { left: 0, top: 0, bottom: 0, right: 0, width: 0, height: 0 }),
    Pa = (e, t) => ((e = Da(e)), t || (e.left = e.left + e.width), (e.right = e.left), (e.width = 0), e),
    La = (e, t, n) => e >= 0 && e <= Math.min(t.height, n.height) / 2,
    Ma = (e, t) => {
      const n = Math.min(t.height / 2, e.height / 2);
      return e.bottom - n < t.top || (!(e.top > t.bottom) && La(t.top - e.bottom, e, t));
    },
    Ia = (e, t) => e.top > t.bottom || (!(e.bottom < t.top) && La(t.bottom - e.top, e, t)),
    Fa = (e, t, n) => {
      ...
      const o = () => (
        ...
        (n = ((e) => {
          const t = [],
            ...
            o = (e, t) => {
              ...
              if (t < e.data.length) {
                ...
                if (Ha(e.data[t - 1]) && (o.setStart(e, t), o.setEnd(e, t + 1), !ni(o))) return void n(si(ri(o), !1));
              }
              t > 0 && (o.setStart(e, t - 1), o.setEnd(e, t), ni(o) || n(si(ri(o), !1))), t < e.data.length && (o.setStart(e, t), o.setEnd(e, t + 1), ni(o) || n(si(ri(o), !0)));
            },
            r = e.container(),
            s = e.offset();
          ...
          if ($a(r))
            if (e.isAtEnd()) {
              const e = Ja(r, s);
              Ya(e) && o(e, e.data.length), Ka(e) && !Xa(e) && n(si(ri(e), !1));
            } else {
              const a = Ja(r, s);
              if ((Ya(a) && o(a, 0), Ka(a) && e.isAtEnd())) return n(si(ri(a), !1)), t;
              const i = Ja(e.container(), e.offset() - 1);
              Ka(i) && !Xa(i) && (qa(i) || qa(a) || !Ka(a)) && n(si(ri(i), !1)), Ka(a) && n(si(ri(a), !0));
            }
          return t;
        })(ai(e, t))),
        n
  ...
  (ai.fromRangeStart = (e) => ai(e.startContainer, e.startOffset)),
    ...
    (ai.isAbove = (e, t) => Dt(ie(t.getClientRects()), le(e.getClientRects()), Ma).getOr(!1)),
    (ai.isBelow = (e, t) => Dt(le(t.getClientRects()), ie(e.getClientRects()), Ia).getOr(!1)),
  ...
  const ii = (e, t) => {
    ...
    fi = (e) => (e ? Oe(e.childNodes, (e, t) => (ci(t) && 'BR' !== t.nodeName ? (e = e.concat(fi(t))) : e.push(t), e), []) : []),
    gi = (e) => (t) => e === t,
    pi = (e) =>
    ...
    hi = (e, t) => {
      ...
      return (a = Ae(a, T(So))), (o = o.concat(Re(a, (e) => pi(e)))), o.reverse().join('/') + ',' + n;
    },
    bi = (e, t) => {
      if (!t) return null;
      const n = t.split(','),
          ...
          (e, t) => {
            ...
            return n
              ? ('text()' === n[1] && (n[1] = '#text'),
                ((e, t, n) => {
                  let o = fi(e);
                  return (o = Ae(o, (e, t) => !di(e) || !di(o[t - 1]))), (o = Ae(o, wo([t]))), o[n];
        ...
        i.push(
          n
            ? ((e, t, n) => {
              ...
              for (let n = t.previousSibling; n && Ro(n); n = n.previousSibling) o += e(n.data).length;
              return o;
            })(t, s, a)
            : a
        );
    ...
    Si = (e, t, n) => {
      ...
      const s = ((e) => ki(e.startContainer, e.startOffset) || ki(e.endContainer, e.endOffset))(r);
      if (s) {
        const e = s.tagName;
      ...
      return ((e, t, n, o) => {
        ...
        return t.isCollapsed() ? { start: s, forward: a, ...i } : { start: s, end: yi(r, e, n, o, !1), forward: a, ...i };
      })(e, n, t, r);
    },
    _i = (e, t, n) => {
    ...
    Ei = (e, t) => {
      ...
      return li(n, o, c), e.moveToBookmark({ id: r, keep: !0, forward: l }), { id: r, forward: l };
    },
    Ni = O(Si, R, !0),
    Ri = (e) => {
      const t = (t) => t(e),
    ...
    Oi = { value: Ri, error: Ai, fromOption: (e, t) => e.fold(() => Ai(t), Ri) },
    Ti = (e) => {
  ...
  Ti([{ bothErrors: ['error1', 'error2'] }, { firstError: ['error1', 'value2'] }, { secondError: ['value1', 'error2'] }, { bothValues: ['value1', 'value2'] }]);
  const Bi = (e) => 'inline-command' === e.type || 'inline-format' === e.type,
    ...
    Pi = (e) => {
      const t = (t) => Oi.error({ message: t, pattern: e }),
        n = (n, o, r) => {
          ...
          return void 0 !== e.cmd ? (m(e.cmd) ? Oi.value(r(e.cmd, e.value)) : t(n + ' pattern has non-string `cmd` parameter')) : t(n + ' pattern is missing both `format` and `cmd` parameters');
        };
      ...
      return void 0 !== e.replacement
        ? m(e.replacement)
          ? 0 === e.start.length
            ...
            : Oi.value({ type: 'inline-command', start: '', end: e.start, cmd: 'mceInsertContent', value: e.replacement })
        ...
        ? ((e, t) =>
          Rd(e) && t.container() === e
            ? ((e, t) => {
              ...
              return (n.text + o.text).length > 0 ? (Td(e), ai(e, t.offset() - n.count)) : t;
            })(e, t)
            : Bd(e, t))(e, t)
        : ((e, t) =>
          t.container() === e.parentNode
            ...
            : Bd(e, t))(e, t),
    Pd = (e) => {
      Nd(e) && Br(e) && (Dr(e) ? e.removeAttribute('data-mce-caret') : Ad(e)), Rd(e) && (Td(e), 0 === e.data.length && Ad(e));
    },
    Ld = Io,
    Md = zo,
    Id = Fo,
        ...
        d = () => {
          ((e) => {
            ...
            for (let e = 0; e < o.length; e++) {
              ...
              (s = r.nextSibling), Mr(s) && (1 === s.data.length ? null === (n = s.parentNode) || void 0 === n || n.removeChild(s) : s.deleteData(0, 1));
            }
          })(t),
            a && (Pd(a), (a = null)),
            r.on((e) => {
        ...
        show: (e, c) => {
          ...
          if (!n(c))
            return (
              (a = ((e, t) => {
                var n;
                const o = (null !== (n = e.ownerDocument) && void 0 !== n ? n : document).createTextNode(_r),
                  r = e.parentNode;
                if (t) {
              ...
              jd(a.nextSibling) ? (u.setStart(a, 0), u.setEnd(a, 0)) : (u.setStart(a, 1), u.setEnd(a, 1)),
              u
            );
          {
            const n = ((e, t, n) => {
              ...
              r.setAttribute('data-mce-caret', n ? 'before' : 'after'), r.setAttribute('data-mce-bogus', 'all'), r.appendChild(xr().dom);
    ...
    cc = (e, t, n) => {
      ...
      if (Ro(a)) {
        ...
        if (Ir(a) && i >= a.data.length - 1) return 1 === e && ((o = s(a)), o) ? lc(o) : n;
  ...
  const bc = Io,
    ...
    Cc = Po,
    wc = Gr,
    xc = (e) => qr(e) || ((e) => !!Yr(e) && !Y(de(e.getElementsByTagName('*')), (e, t) => e || zr(t), !1))(e),
    kc = Xr,
    Sc = (e, t) => (e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null),
    _c = (e, t) => {
      if (Jd(e)) {
    ...
    Ec = (e, t, n) => {
      ...
      if (t.isEqual(ai.after(n)) && n.lastChild) {
        if (((a = ai.after(n.lastChild)), Zd(e) && wc(n.lastChild) && yc(n.lastChild))) return Cc(n.lastChild) ? ai.before(n.lastChild) : a;
      } else a = t;
      const i = a.container();
      let l = a.offset();
      if (vc(i)) {
        ...
        if (Zd(e) && l > 0 && ((r = Sc(i, l - 1)), wc(r))) return !xc(r) && ((s = tc(r, e, kc, r)), s) ? (vc(s) ? ai(s, s.data.length) : ai.after(s)) : vc(r) ? ai(r, r.data.length) : ai.before(r);
        if (Jd(e) && l < i.childNodes.length && ((r = Sc(i, l)), wc(r)))
          return Cc(r)
            ? ((e, t) => {
              const n = t.nextSibling;
              return n && wc(n) ? (vc(n) ? ai(n, 0) : ai.before(n)) : Ec(hc.Forwards, ai.after(t), e);
            })(n, r)
      ...
      if (o && ((Jd(e) && a.isAtEnd()) || (Zd(e) && a.isAtStart())) && ((o = tc(o, e, L, n, !0)), kc(o, n))) return _c(e, o);
      r = o ? tc(o, e, kc, n) : o;
      const d = Be(
        K(
          ((e, t) => {
      ...
      return !d || (r && d.contains(r)) ? (r ? _c(e, r) : null) : ((a = Jd(e) ? ai.after(d) : ai.before(d)), a);
    },
    Nc = (e) => ({ next: (t) => Ec(hc.Forwards, t, e), prev: (t) => Ec(hc.Backwards, t, e) }),
    ...
    Oc = (e, t) => !ai.isTextPosition(e) && !ai.isTextPosition(t) && e.getNode() === t.getNode(!0),
    Tc = (e, t, n) => {
      const o = Nc(t);
    ...
    Bc = (e, t, n) =>
      Tc(e, t, n).bind((o) =>
        oc(n, o, t) &&
          ((e, t, n) => {
            return e ? !Oc(t, n) && ((o = t), !(!ai.isTextPosition(o) && Po(o.getNode()))) && Ac(t) && Rc(n) : !Oc(n, t) && Rc(t) && Ac(n);
            var o;
          })(e, n, o)
          ? Tc(e, t, o)
          : M.some(o)
      ),
    Dc = (e, t, n, o) => Bc(e, t, n).bind((n) => (o(n) ? Dc(e, t, n, o) : M.some(n))),
    Pc = (e, t) => {
    ...
    qc = (e, t) => (yo(t) && e.isBlock(t) && !t.innerHTML && (t.innerHTML = '<br data-mce-bogus="1" />'), t),
    Wc = (e, t) => Fc(e).fold(P, (e) => (t.setStart(e.container(), e.offset()), t.setEnd(e.container(), e.offset()), !0)),
    Kc = (e, t, n) =>
      !(
        !((e) => !e.hasChildNodes())(t) ||
        !jc(e, t) ||
    ...
    Gc = (e, t, n, o) => {
      ...
      if (r) {
        ...
        Ro(e) && (n = Math.min(r[0], e.data.length)), yo(e) && (n = Math.min(r[0], e.childNodes.length)), t ? o.setStart(e, n) : o.setEnd(e, n);
      }
      return !0;
    },
      ...
      ((e, t, n = !1) =>
        2 === t
          ...
          : 3 === t
            ? ((e) => {
              const t = e.getRng();
              return { start: hi(e.dom.getRoot(), ai.fromRangeStart(t)), end: hi(e.dom.getRoot(), ai.fromRangeEnd(t)), forward: e.isForward() };
            })(e)
            : t
      ...
      ((e, t) => {
        ...
        if (t) {
          if ($c(t))
            return ((e, t) => {
              const n = e.createRng();
              return Gc(e, !0, t, n) && Gc(e, !1, t, n) ? M.some({ range: n, forward: Vc(t) }) : M.none();
            })(n, t);
          if (((e) => m(e.start))(t))
            return ((e, t) => {
              ...
              return Dt(n, o, (n, o) => {
                const r = e.createRng();
                return r.setStart(n.container(), n.offset()), r.setEnd(o.container(), o.offset()), { range: r, forward: Vc(t) };
              });
            })(n, t);
          if (((e) => xe(e, 'id'))(t))
            return ((e, t) => {
              ...
              return Dt(n, o.or(n), (n, o) => {
                const r = e.createRng();
                return r.setStart(qc(e, n.container()), n.offset()), r.setEnd(qc(e, o.container()), o.offset()), { range: r, forward: Vc(t) };
              });
            })(n, t);
          if (Hc(t))
            return ((e, t) =>
          ...
          if (((e) => xe(e, 'rng'))(t)) return M.some({ range: t.rng, forward: Vc(t) });
        }
        return M.none();
    ...
    Zc = (e) => yo(e) && 'SPAN' === e.tagName && 'bookmark' === e.getAttribute('data-mce-type'),
    eu = (pr, (e) => '\xa0' === e);
  const tu = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
    nu = (e) => !tu(e) && !eu(e) && !hr(e),
    ou = (e) => {
    ...
    au = /^\s*rgba\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d?(?:\.\d+)?)\s*\)\s*$/i,
    ...
    hu = (e, t) =>
      Dt(
        ((e) => {
          const t = e.startContainer,
            n = e.startOffset;
          return Ro(t) ? (0 === n ? M.some(mn(t)) : M.none()) : M.from(t.childNodes[n]).map(mn);
        })(t),
        ((e) => {
          const t = e.endContainer,
            n = e.endOffset;
          return Ro(t) ? (n === t.data.length ? M.some(mn(t)) : M.none()) : M.from(t.childNodes[n - 1]).map(mn);
        })(t),
        (t, n) => {
    ...
    bu = (e, t, n, o) => {
      ...
      let i = n;
      do {
        if (Ro(i) && 0 !== Tt.trim(i.data).length) return void (o ? t.setStart(i, 0) : t.setEnd(i, i.data.length));
    ...
    Su = (e, t, n) => {
      ...
      Cu(o, !0, () => {
        ...
        a && Io(s) && r.isChildOf(s, e.getBody()) ? e.selection.select(s) : n(o.getStart()) && _u(r, o);
    },
    _u = (e, t) => {
      var n, o;
      const r = t.getRng(),
    ...
    Nu = (e, t) => (wu(t) && (t = t.nodeName), !!e.schema.getTextBlockElements()[t.toLowerCase()]),
    ...
    Tu = (e, t) => (w(e) ? e(t) : (C(t) && (e = e.replace(/%(\w+)/g, (e, n) => t[n] || e)), e)),
    Bu = (e, t) => ((t = t || ''), (e = '' + ((e = e || '').nodeName || e)), (t = '' + (t.nodeName || t)), e.toLowerCase() === t.toLowerCase()),
    Du = (e, t) => {
      if (y(e)) return null;
      {
        let n = String(e);
        return ('color' !== t && 'backgroundColor' !== t) || (n = du(n)), 'fontWeight' === t && 700 === e && (n = 'bold'), 'fontFamily' === t && (n = n.replace(/[\'\"]/g, '').replace(/,\s+/g, ',')), n;
      }
    },
    Pu = (e, t, n) => {
    ...
    Lu = (e, t) => {
      let n;
      return e.getParent(t, (t) => !!yo(t) && ((n = e.getStyle(t, 'text-decoration')), !!n && 'none' !== n)), n;
    },
    ...
    Xu = (e, t, n, o, r, s) => {
      ...
      const i = e.getParent(n, e.isBlock) || t,
        l = (t, n, o) => {
          ...
          return M.from(l(t, n, (e, t) => (Hu(e.parentNode) ? -1 : ((a = e), o(r, e, t))), i));
        };
      return l(n, o, Gu)
        .bind((e) => (s ? l(e.container, e.offset + (r ? -1 : 0), Yu) : M.some(e)))
    ...
    Qu = (e, t, n, o, r) => {
      ...
      for (let o = 0; o < a.length; o++)
        for (let r = 0; r < t.length; r++) {
          const s = t[r];
          if ((!C(s.collapsed) || s.collapsed === n.collapsed) && Uu(s) && e.is(a[o], s.selector)) return a[o];
        }
      return o;
    },
    Ju = (e, t, n, o) => {
      ...
      if ((Fu(l) && (s = l.wrapper ? null : a.getParent(n, l.block, i)), !s)) {
        const t = null !== (r = a.getParent(n, 'LI,TD,TH')) && void 0 !== r ? r : i;
        s = a.getParent(Ro(n) ? n.parentNode : n, (t) => t !== i && qu(e, t), t);
      }
      if ((s && Fu(l) && l.wrapper && (s = $u(a, s, 'ul,ol').reverse()[0] || s), !s)) for (s = n; s && s[o] && !a.isBlock(s[o]) && ((s = s[o]), !Bu(s, 'br')););
      return s || n;
    },
    Zu = (e, t, n, o) => {
      const r = n.parentNode;
      return !C(n[o]) && (!(r !== t && !y(r) && !e.isBlock(r)) || Zu(e, t, r, o));
    },
    em = (e, t, n, o, r) => {
      let s = n;
      ...
      for (; s;) {
        ...
        for (let t = s[a]; t; t = t[a]) {
          ...
          if (!Hu(t) && (!Po((l = t)) || !l.getAttribute('data-mce-bogus') || l.nextSibling) && !Vu(t, n)) return s;
        }
    ...
    nm = (e, t, n, o = !1) => {
      ...
      return (
        ...
        yo(a) && a.hasChildNodes() && ((a = za(a, t.collapsed ? i : i - 1)), Ro(a) && (i = a.data.length)),
        (r = Wu(l, r)),
        (a = Wu(l, a)),
        tm(r) && ((r = Hu(r) ? r : r.parentNode), (r = t.collapsed ? r.previousSibling || r : r.nextSibling || r), Ro(r) && (s = t.collapsed ? r.length : 0)),
        tm(a) && ((a = Hu(a) ? a : a.parentNode), (a = t.collapsed ? a.nextSibling || a : a.previousSibling || a), Ro(a) && (i = t.collapsed ? 0 : a.length)),
        t.collapsed &&
        (Xu(l, e.getBody(), r, s, !0, o).each(({ container: e, offset: t }) => {
          (r = e), (s = t);
        }),
          Xu(l, e.getBody(), a, i, !1, o).each(({ container: e, offset: t }) => {
            (a = e), (i = t);
          })),
        (zu(d) || d.block_expand) && ((zu(d) && Ro(r) && 0 !== s) || (r = em(l, n, r, s, !0)), (zu(d) && Ro(a) && i !== a.data.length) || (a = em(l, n, a, i, !1))),
        ju(d) && ((r = Qu(l, n, t, r, 'previousSibling')), (a = Qu(l, n, t, a, 'nextSibling'))),
        (Fu(d) || Uu(d)) && ((r = Ju(e, n, r, 'previousSibling')), (a = Ju(e, n, a, 'nextSibling')), Fu(d) && (l.isBlock(r) || (r = em(l, n, r, s, !0)), l.isBlock(a) || (a = em(l, n, a, i, !1)))),
    ...
    om = (e, t, n) => {
      ...
      const r = t.startOffset,
        ...
        l = (e) => {
          ...
          return 0 === a && e.length > 0 && n === i && Ro(n) && e.splice(e.length - 1, 1), e;
        },
        d = (e, t, n) => {
          const o = [];
    ...
    rm = ['pre[class*=language-][contenteditable="false"]', 'figure.image', 'div[data-ephox-embed-iri]', 'div.tiny-pageembed', 'div.mce-toc', 'div[data-mce-toc]'],
    sm = (e, t, n, o, r, s) => {
      const { uid: a = t, ...i } = n;
        ...
        const n = pa(),
          ...
          r = (e) => {
            ...
            const s = null !== (n = null === (t = e.attr('class')) || void 0 === t ? void 0 : t.split(' ')) && void 0 !== n ? n : [],
              a = oe(s, [ga()].concat(r));
            e.attr('class', a.length > 0 ? a.join(' ') : null), e.attr(va(), null), e.attr(ya(), null);
          };
        ...
        r = (e) => {
          V(e, (e) => {
            o(e)
              ? no(e)
              : ((e) => {
                rn(e, ga()), Yt(e, `${ha()}`), Yt(e, `${pa()}`), Yt(e, `${ba()}`);
                const t = Kt(e, `${ya()}`)
                  .map((e) => e.split(','))
                  .getOr([]),
                  n = Kt(e, `${va()}`)
  ...
  const cm = (e, t, n) => !n.collapsed && H(n.getClientRects(), (n) => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t)),
    um = (e, t, n) => {
      e.dispatch(t, n);
    },
    mm = (e, t, n, o) => {
    ...
    bm = {
      ...
      END: 35,
      HOME: 36,
      modifierPressed: (e) => e.shiftKey || e.ctrlKey || e.altKey || bm.metaKeyPressed(e),
      metaKeyPressed: (e) => (Nt.os.isMacOS() || Nt.os.isiOS() ? e.metaKey : e.ctrlKey && !e.altKey),
    },
    vm = 'data-mce-selected',
    ym = Math.abs,
    Cm = Math.round,
    wm = { nw: [0, 0, -1, -1], ne: [1, 0, 1, -1], se: [1, 1, 1, 1], sw: [0, 1, -1, 1] },
    xm = (e, t) => {
      const n = t.dom,
        o = t.getDoc(),
        r = document,
      ...
      const x = (e) => C(e) && (Lo(e) || n.is(e, 'figure.image')),
        ...
        A = (e) => {
          ...
          (o = e.screenX - u),
            ...
            (b = b < 5 ? 5 : b),
            (v = v < 5 ? 5 : v),
            (c = (x(a) || k(a)) && !1 !== El(t) ? !bm.modifierPressed(e) : bm.modifierPressed(e)),
            c && (ym(o) > ym(r) ? ((v = Cm(b * p)), (b = Cm(v / p))) : ((b = Cm(v / p)), (v = Cm(b * p)))),
            R(i, b, v),
            (C = d.startPos.x + o),
            (S = d.startPos.y + r),
            (C = C > 0 ? C : 0),
        ...
        L = (o) => {
          ...
          const r = 'mousedown' === o.type ? o.target : e.getNode(),
            a = Xo(mn(r), 'table,img,figure.image,hr,video,span.mce-preview-object')
              .map((e) => e.dom)
              .getOrUndefined(),
            i = C(a) ? n.getAttrib(a, vm, '1') : '1';
          if (
            (V(n.select('img[data-mce-selected],hr[data-mce-selected]'), (e) => {
            ...
            if (P(t, a) && P(e.getEnd(!0), a)) return n.setAttrib(a, vm, i), void B.throttle(a);
          }
          D();
        },
        M = () => {
    ...
    _m = Ti([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]),
    Em = (e, t, n) => t(mn(n.startContainer), n.startOffset, mn(n.endContainer), n.endOffset);
  _m.ltr, _m.rtl;
  const Nm = (e, t, n, o) => ({ start: e, soffset: t, finish: n, foffset: o }),
    Rm = document.caretPositionFromPoint
      ...
      : document.caretRangeFromPoint
        ...
        : M.none,
    Am = Ti([{ before: ['element'] }, { on: ['element', 'offset'] }, { after: ['element'] }]),
    Om = { before: Am.before, on: Am.on, after: Am.after, cata: (e, t, n, o) => e.fold(t, n, o), getStart: (e) => e.fold(R, R, R) },
    Tm = Ti([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
    Bm = {
      ...
      getWin: (e) => {
        const t = ((e) => e.match({ domRange: (e) => mn(e.startContainer), relative: (e, t) => Om.getStart(e), exact: (e, t, n, o) => e }))(e);
        return wn(t);
      },
      range: Nm,
    },
    Dm = (e, t) => {
      const n = Lt(e);
      return 'input' === n ? Om.after(e) : j(['br', 'img'], n) ? (0 === t ? Om.before(e) : Om.after(e)) : Om.on(e, t);
    },
    Pm = (e, t) => {
      ...
      return ((e, t) => {
        const n = ((e, t) =>
          t.match({
            ...
            relative: (t, n) => ({ ltr: De(() => km(e, t, n)), rtl: De(() => M.some(km(e, n, t))) }),
            exact: (t, n, o, r) => ({ ltr: De(() => Sm(e, t, n, o, r)), rtl: De(() => M.some(Sm(e, o, r, t, n))) }),
          }))(e, t);
        return ((e, t) => {
          const n = t.ltr();
          return n.collapsed
            ? t
              ...
              .map((e) => _m.rtl(mn(e.endContainer), e.endOffset, mn(e.startContainer), e.startOffset))
    ...
    Fm = (e, t, n) =>
      ((e, t, n) =>
        ((e, t, n) => {
          ...
          return Rm(o, t, n).map((e) => Nm(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset));
        ...
        .getOrUndefined(),
    Um = (e, t) => C(e) && C(t) && e.startContainer === t.startContainer && e.startOffset === t.startOffset && e.endContainer === t.endContainer && e.endOffset === t.endOffset,
    zm = (e, t, n) =>
      null !==
      ((e, t, n) => {
        let o = e;
    ...
    Vm = (e, t, n, o, r) => {
      ...
      const u = new Zo(r, c);
      for (; (d = u[o ? 'prev' : 'next']());) {
        if ('false' === e.getContentEditableParent(d) || Hm(d, s)) return M.none();
        if (Ro(d) && d.data.length > 0) return jm(d, s, 'A') ? M.none() : M.some(ai(d, o ? d.data.length : 0));
    ...
    qm = (e, t, n, o) => {
      ...
      if ((yo(i) && l > i.childNodes.length - 1 && (u = !1), Bo(i) && ((i = r), (l = 0)), i === r)) {
        if (u && ((s = i.childNodes[l > 0 ? l - 1 : 0]), s)) {
          if (Br(s)) return M.none();
          if (c[s.nodeName] || _o(s)) return M.none();
        }
        if (i.hasChildNodes()) {
          if (((l = Math.min(!u && l > 0 ? l - 1 : l, i.childNodes.length - 1)), (i = i.childNodes[l]), (l = Ro(i) && d ? i.data.length : 0), !t && i === r.lastChild && _o(i))) return M.none();
          if (
            ((e, t) => {
              let n = t;
              for (; n && n !== e;) {
    ...
    Gm = (e) => {
      ...
      } else if ((Ro(t) && n > 0 && n < t.data.length && ((t = Km(t, n)), (n = 0)), Ro(o) && r > 0 && r < o.data.length)) {
        const e = Km(o, r).previousSibling;
        (o = e), (r = e.data.length);
      }
      return { startContainer: t, startOffset: n, endContainer: o, endOffset: r };
    },
    Ym = (e) => ({ walk: (t, n) => om(e, t, n), split: Gm, normalize: (t) => Wm(e, t).fold(P, (e) => (t.setStart(e.startContainer, e.startOffset), t.setEnd(e.endContainer, e.endOffset), !0)) });
  (Ym.compareRanges = Um), (Ym.getCaretRangeFromPoint = Fm), (Ym.getSelectedNode = Ua), (Ym.getNode = za);
  const Xm = ((e, t) => {
    const n = (t) => {
      const n = ((e) => {
        const t = e.dom;
  ...
  const ef = (e) => 'textarea' === Lt(e),
      ...
      const a = ((e, t) => {
        const n = ((e, t) => {
          ...
          if (t < n.length && !ef(n[t])) return { element: n[t], offset: 0 };
          {
            ...
            return ef(o) ? { element: e, offset: t } : 'img' === Lt(o) ? { element: o, offset: 1 } : Ut(o) ? { element: o, offset: Cr(o).length } : { element: o, offset: Nn(o).length };
          }
        })(e, t),
    ...
    df = (e, t, n, o, r) => {
      const s = n + t,
        ...
        i = o.bottom,
        l = i - a >= n;
      a < t ? lf(o, n, !1 !== r, e) : a > s ? lf(o, n, l ? !1 !== r : !0 === r, e) : i > s && !l && lf(o, n, !0 === r, e);
    },
    cf = (e, t, n, o) => {
    ...
    wf = (e) => Bm.range(e.start, Cf(e.soffset, e.start), e.finish, Cf(e.foffset, e.finish)),
    xf = (e, t) => !vo(t.dom) && (vn(e, t) || bn(e, t)),
    kf = (e) => (t) => xf(e, t.start) && xf(e, t.finish),
    Sf = (e) => Bm.range(mn(e.startContainer), e.startOffset, mn(e.endContainer), e.endOffset),
    _f = (e) => {
      ...
      const t = ((e) => e.inline)(e)
        ? ((n = mn(e.getBody())),
          ((e) => {
            ...
            return (t && 0 !== t.rangeCount ? M.from(t.getRangeAt(0)) : M.none()).map(Sf);
  ...
  const Tf = ta.DOM,
    Bf = (e, t) => {
      const n = Ul(e),
        o = Tf.getParent(t, (t) => ((e) => yo(e) && Rf.isEditorUIElement(e))(t) || (!!n && e.dom.is(t, n)));
      return null !== o;
    },
    Df = (e, t) => {
      const n = t.editor;
      ((e) => {
            ...
            ((e, t) => {
              ((e, t) => {
                ...
                e.on('keyup NodeChange AfterSetSelectionRange', (t) => {
                  ((e) => 'nodechange' === e.type && e.selectionChange)(t) || Ef(e);
                });
            })(e, t);
        }),
          e.on('remove', () => {
        ...
        ((Of = (t) => {
          ...
          n &&
            Fn(t).each((t) => {
              const o = t;
              o.ownerDocument === document && (o === document.body || Bf(n, o) || e.focusedEditor !== n || (n.dispatch('blur', { focusedEditor: null }), (e.focusedEditor = null)));
            });
        }),
          Tf.bind(document, 'focusin', Of));
    },
    Pf = (e, t) => {
      e.focusedEditor === t.editor && (e.focusedEditor = null), !e.activeEditor && Of && (Tf.unbind(document, 'focusin', Of), (Of = null));
    },
    Lf = (e, t) => {
      ((e, t) => ((e) => (e.collapsed ? M.from(za(e.startContainer, e.startOffset)).map(mn) : M.none()))(t).bind((t) => (lr(t) ? M.some(t) : vn(e, t) ? M.none() : M.some(e))))(mn(e.getBody()), t)
        .bind((e) => Ic(e.dom))
        .fold(
          () => {
    ...
    If = (e) =>
      e.inline
        ? ((e) => {
          const t = e.getBody();
          return t && ((n = mn(t)), vf(n) || ((o = n), yf(Ln(o)).filter((e) => o.dom.contains(e.dom))).isSome());
          var n, o;
        })(e)
    ...
    Gf = (e) => Yo(e, Wf),
    Yf = { '#text': 3, '#comment': 8, '#cdata': 4, '#pi': 7, '#doctype': 10, '#document-fragment': 11 },
    Xf = (e, t, n) => {
    ...
    isEmpty(e, t = {}, n) {
      ...
      if (s)
        do {
          ...
          if (3 === s.type && s.parent && t[s.parent.name] && Jr(null !== (o = s.value) && void 0 !== o ? o : '')) return !1;
          if (n && n(s)) return !1;
        } while ((s = Xf(s, r)));
      return !0;
    }
    ...
    tg = (e, t, n) => {
      ...
      for (; 0 !== a;)
        for (o.lastIndex = i; ;) {
          ...
          if (null === e) return i;
          if ('!' === e[1]) {
            i = ze(e[2], '--') ? eg(t, !1, e.index + '!--'.length) : eg(t, !0, e.index + 1);
            break;
          }
          {
    ...
    ng = (e, t) => {
      ...
      for (; (a = n.exec(r));) {
        const e = n.lastIndex,
          t = a[0].length;
        let i;
        (i = s[a[1]] ? e : tg(o, r, e)), (r = r.substring(0, e - t) + r.substring(i)), (n.lastIndex = e - t);
      }
      return Nr(r);
    },
    og = ng,
            ...
            : 'text' === t.format
              ? ((e, t) => {
                const n = e.getDoc(),
                  o = Ln(mn(e.getBody())),
                  r = cn('div', n);
                Vt(r, 'data-mce-bogus', 'all'), $n(r, { position: 'fixed', left: '-9999999px', top: '0' }), ro(r, t.innerHTML);
                const s = vr(r, '[data-mce-bogus]');
                V(s, (e) => {
                  'all' === Wt(e, 'data-mce-bogus') ? to(e) : rr(e) ? (Yn(e, un(gr)), to(e)) : no(e);
                });
  ...
  const dg = ['font', 'text-decoration', 'text-emphasis'],
    ...
    pg = (e) => {
      const t = e.container();
      return Ro(t) && (0 === t.data.length || (Er(t.data) && dm.isBookmarkNode(t.parentNode)));
    },
    hg = (e, t) => (n) =>
      rc(e ? 0 : -1, n)
        .filter(t)
    ...
    vg = (e) => Io(e) && !((e) => yo(e) && 'all' === e.getAttribute('data-mce-bogus'))(e),
    yg = hg(!0, bg),
    Cg = hg(!1, bg),
    wg = hg(!0, zo),
    xg = hg(!1, zo),
    ...
    zg = (e, t) => ((e) => M.from(e.getNode(!0)).map(mn))(t).exists(rr) || Fg(!1, e, t).isSome(),
    jg = O(Fg, !1),
    Hg = O(Fg, !0),
    ...
    Kg = (e) =>
      fc(e)
        .bind((e) => Ko(e, Ft))
        .exists((e) => ((e) => j(['pre', 'pre-wrap'], e))(Vn(e, 'white-space'))),
    Gg = (e, t) => (n) => {
    ...
    ep = (e, t, n) => {
      const o = t.data,
        r = ai(t, 0);
      return n || !Jg(o, 0) || Qg(e, r) ? !!(n && Zg(o, 0) && Yg(e, r)) && ((t.data = pr + o.slice(1)), !0) : ((t.data = ' ' + o.slice(1)), !0);
    },
    tp = (e, t, n) => {
      const o = t.data,
        r = ai(t, o.length - 1);
      return n || !Jg(o, o.length - 1) || Qg(e, r) ? !!(n && Zg(o, o.length - 1) && Xg(e, r)) && ((t.data = o.slice(0, -1) + pr), !0) : ((t.data = o.slice(0, -1) + ' '), !0);
    },
    np = (e, t) => {
      const n = t.container();
        ...
        const o =
          ...
          ((e) => {
            const t = e.data,
              n = ((e) => {
                const t = e.split('');
                return $(t, (e, n) => (eu(e) && n > 0 && n < t.length - 1 && nu(t[n - 1]) && nu(t[n + 1]) ? ' ' : e)).join('');
              })(t);
    ...
    ap = (e, t, n, o = !0) => {
      const r = qe(e.data).length,
        s = o ? e : t,
        a = o ? t : e;
      return o ? s.appendData(a.data) : s.insertData(0, a.data), to(mn(a)), n && rp(s, r), s;
    },
    ip = (e, t) =>
      ((e, t) => {
        const n = e.container(),
          o = e.offset();
        return !ai.isTextPosition(e) && n === t.parentNode && o > ai.before(t).offset();
      })(t, e)
        ? ai(t.container(), t.offset() - 1)
        : t,
    lp = (e) => {
      return Gr(e.previousSibling) ? M.some(((t = e.previousSibling), Ro(t) ? ai(t, t.data.length) : ai.after(t))) : e.previousSibling ? Fc(e.previousSibling) : M.none();
      var t;
    },
    dp = (e) => {
      return Gr(e.nextSibling) ? M.some(((t = e.nextSibling), Ro(t) ? ai(t, 0) : ai.before(t))) : e.nextSibling ? Ic(e.nextSibling) : M.none();
      var t;
    },
    cp = (e, t, n) =>
      ((e, t, n) =>
        e
          ? ((e, t) =>
            dp(t)
              .orThunk(() => lp(t))
              .orThunk(() => ((e, t) => Lc(e, ai.after(t)).orThunk(() => Mc(e, ai.before(t))))(e, t)))(t, n)
          : ((e, t) =>
            lp(t)
              .orThunk(() => dp(t))
              .orThunk(() =>
      ...
      const i = ((e, t, n) => {
        ...
        return (
          ...
          ((s = o),
            ...
            s.isSome() && a.isSome() && i.isSome() ? M.some(l(s.getOrDie(), a.getOrDie(), i.getOrDie())) : M.none()).orThunk(() => (n && (o.each((e) => sp(e.dom, e.dom.length)), r.each((e) => rp(e.dom, 0))), t))
        );
        var s, a, i, l;
    ...
    hp = (e, t) => pn(mn(t), Sl(e)),
    bp = (e, t, n) => {
      const o = ((e, t, n) => K(ta.DOM.getParents(n.container(), '*', t), e))(e, t, n);
    ...
    Ep = (e) => {
      var t;
      return (8 === Mt((t = e)) || '#comment' === Lt(t) ? kn(e) : On(e)).bind(Ep).orThunk(() => M.some(e));
    },
    Np = (e, t, n, o = !0) => {
      var r;
      t.deleteContents();
      ...
      if ((a.dom === e.getBody() ? _p(e, o) : ss(a) && (kr(a), o && e.selection.setCursorLocation(a.dom, 0)), !bn(n, a))) {
        const e = Bt(xn(a), n)
          ? []
          : xn((i = a))
            .map(Nn)
    ...
    Op = Ti([{ singleCellTable: ['rng', 'cell'] }, { fullTable: ['table'] }, { partialTable: ['cells', 'outsideDetails'] }, { multiTable: ['startTableCells', 'endTableCells', 'betweenRng'] }]),
    Tp = (e, t) => Xo(mn(e), 'td,th', t),
    Bp = (e) => !bn(e.start, e.end),
    Dp = (e, t) => fu(e.start, t).bind((n) => fu(e.end, t).bind((e) => Pt(bn(n, e), n))),
    Pp = (e) => (t) => Dp(t, e).map((e) => ((e, t, n) => ({ rng: e, table: t, cells: n }))(t, e, Rp(e))),
    Lp = (e, t, n, o) => {
    ...
    Mp = (e, t) => J(e, (e) => bn(e, t)),
    Ip = (e) => Dt(Mp(e.cells, e.rng.start), Mp(e.cells, e.rng.end), (t, n) => e.cells.slice(t, n + 1)),
    Fp = (e, t) => {
            ...
            Lp(e, t, n, o)
              ...
              .bind((e) => {
                const { isSameTable: o } = t,
                  r = Ip(e).getOr([]);
                if (o && e.cells.length === r.length) return M.some(Op.fullTable(e.table));
                if (r.length > 0) {
    ...
    jp = (e, t, n, o) => {
      ...
      o ? (r.setStart(n.startContainer, n.startOffset), r.setEndAfter(t.dom.lastChild)) : (r.setStartBefore(t.dom.firstChild), r.setEnd(n.endContainer, n.endOffset)), qp(e, r, t, !1).each((e) => e());
    },
    Hp = (e) => {
      const t = mu(e),
        n = mn(e.selection.getNode());
      Fo(n.dom) && ss(n) ? e.selection.setCursorLocation(n.dom, 0) : e.selection.collapse(!0), t.length > 1 && H(t, (e) => bn(e, n)) && Vt(n, 'data-mce-selected', '1');
    },
    $p = (e, t, n) =>
      M.some(() => {
        const o = e.selection.getRng(),
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              ...
              return jp(e, a, o, r), ss(a) ? M.none() : M.some(r ? t.slice(1) : t.slice(0, -1));
            })
            .getOr(t);
        zp(r), Hp(e);
      }),
      ...
      return Gp(o, n).fold(
        () =>
          ((e, t, n, o) => {
            ...
            return Kp(n, o).bind((o) => (ss(o) ? Yp(e, o) : ((e, t, n, o, r) => Bc(n, e.getBody(), r).bind((e) => Kp(t, mn(e.getNode())).bind((e) => (bn(e, o) ? M.none() : M.some(S)))))(e, n, t, o, r)));
          })(e, t, o, n).orThunk(() =>
            Pt(
              ((e, t) => {
              ...
              : ((e, t, n, o, r) =>
                Bc(n, e.getBody(), r).fold(
                  ...
                  (s) =>
                    ((e, t, n, o) =>
                      Ic(e.dom)
                        .bind((r) => Fc(e.dom).map((e) => (t ? n.isEqual(r) && o.isEqual(e) : n.isEqual(e) && o.isEqual(r))))
                        .getOr(!0))(o, n, r, s)
                      ? ((e, t) => Yp(e, t))(e, o)
                      : ((e, t, n) =>
      ...
      return e.selection.isCollapsed() && 0 === o.length
        ...
        : ((e, t, n) => {
          ...
          return 0 !== n.length
            ...
            : ((e, t, n, o) =>
              Gp(t, o).fold(
                () => ((e, t, n) => Up(t, n).bind((t) => t.fold(O(qp, e), O(Wp, e), O($p, e), O(Vp, e))))(e, t, n),
                (t) => ((e, t) => Yp(e, t))(e, t)
              ))(e, o, r, t);
        })(e, n, o);
    },
      ...
      for (let l = 0; l < e.length; l++) {
        ...
        if (c && f.length > 1)
          if (t.isValidChild(c.name, d.name)) {
            ...
            lh(t, r, s, u) ? c.insert(d, f[0], !0) : (c.insert(u, f[0], !0), c.insert(d, u)), (c = f[0]), (lh(t, r, s, c) || ih(c, 'br')) && c.empty().remove();
          } else dh(d, t);
        else if (d.parent) {
          if ('li' === d.name) {
            let e = d.prev;
    ...
    fh = (e) => {
      return e.length > 0 && (!(n = e[e.length - 1]).firstChild || (C(null == (t = n) ? void 0 : t.firstChild) && t.firstChild === t.lastChild && ((e) => e.data === pr || Po(e))(t.firstChild))) ? e.slice(0, -1) : e;
      var t, n;
    },
    gh = (e, t) => {
    ...
    hh = (e, t, n, o) => {
      const r = ((e, t, n) => {
        ...
        a = fh(((i = r.firstChild), K(null !== (l = null == i ? void 0 : i.childNodes) && void 0 !== l ? l : [], (e) => 'LI' === e.nodeName)));
      var i, l;
      const d = t.getRoot(),
        c = (e) => {
      ...
      return s
        ? c(1)
          ...
          : c(2)
            ? ((e, t, n, o) => (o.insertAfter(t.reverse(), e), ph(t[0], n)))(s, a, d, t)
            : ((e, t, n, o) => {
              const r = ((e, t) => {
    ...
    yh = (e, t, n) => {
      ...
      -1 === t.indexOf('{$caret}') && (t += '{$caret}'), (t = t.replace(/\{\$caret\}/, u));
      let m = a.getRng();
      ...
      f === g &&
        ...
        ((e, t) => C(t) && !e.schema.getVoidElements()[t.nodeName])(e, g.firstChild) &&
        i.isEmpty(g.firstChild) &&
        ((m = i.createRng()), m.setStart(g.firstChild, 0), m.setEnd(g.firstChild, 0), a.setRng(m)),
        a.isCollapsed() ||
        ((e) => {
          const t = e.dom,
          ...
          ((e, t, n) => !!C(n) && n === e.getParent(t.endContainer, vh) && hu(mn(n), t))(t, n, o) ? qp(e, n, mn(o)) : e.getDoc().execCommand('Delete', !1);
        })(e);
      const p = a.getNode(),
        h = { context: p.nodeName.toLowerCase(), data: n.data, insert: !0 },
        b = l.parse(t, h);
      if (!0 === n.paste && mh(e.schema, b) && ((e, t) => !!gh(e, t))(i, p)) return (m = hh(c, i, a.getRng(), b)), m && a.setRng(m), t;
      !0 === n.paste &&
        ((e, t, n, o) => {
          var r;
      ...
      if ((e._selectionOverrides.showBlockCaretContainer(p), h.invalid)) {
        ...
        let n,
          o = a.getNode();
        const d = e.getBody();
        for (Bo(o) ? (o = n = d) : (n = o); n && n !== d;) (o = n), (n = n.parentNode);
        ...
        const f = b.children(),
          g = null !== (s = null === (r = b.parent) || void 0 === r ? void 0 : r.name) && void 0 !== s ? s : m.name;
        b.unwrap();
        const p = K(f, (t) => !e.schema.isValidChild(g, t.name));
        ch(p, e.schema), sh(l.getNodeFilters(), l.getAttributeFilters(), m), (t = c.serialize(m)), o === d ? i.setHTML(d, t) : i.setOuterHTML(o, t);
      } else
        (t = c.serialize(b)),
          ((e, t, n) => {
            var o;
      ...
      return (
        ((e, t) => {
          ...
          if (t) {
            ...
            Tt.each(o.select('*[data-mce-fragment]'), (e) => {
              if (C(n[e.nodeName.toLowerCase()]) && ((e, t) => te(cg(e, t), (e) => !((e) => lg.has(e))(e)))(o, e))
                for (let n = e.parentElement; C(n) && n !== t && !ug(o, e, n); n = n.parentElement)
                  if (r.compare(n, e)) {
                    o.remove(e, !0);
                    break;
                  }
        ...
        ((e, t) => {
          ...
          if (Ro(c)) {
            ...
            Ro(e) && (c.appendData(e.data), null === (r = e.parentNode) || void 0 === r || r.removeChild(e));
            ...
            (eo(mn(u)),
              ...
              vh(u) ||
                ...
                !(s = ((t) => {
                  ...
                  return (n = Nc(e.getBody()).next(n)), null == n ? void 0 : n.toRange();
                })(d))
    ...
    Nh = (e, t, n, o, r) => {
      ...
      if (t === s) return !1;
      const a = e.dom.getParent(t, (t) => !!Eh(e, t, n) || t.parentNode === s || !!Oh(e, t, n, o, !0));
      return !!Oh(e, a, n, o, r);
    },
    Rh = (e, t, n) => !(!zu(n) || !_h(t, n.inline)) || !(!Fu(n) || !_h(t, n.block)) || (!!Uu(n) && yo(t) && e.is(t, n.selector)),
    Ah = (e, t, n, o, r, s) => {
      const a = n[o],
        i = 'attributes' === o;
      ...
      if (a)
        if (_e(a)) {
          for (let n = 0; n < a.length; n++) if (i ? e.getAttrib(t, a[n]) : Pu(e, t, a[n])) return !0;
        } else
          for (const o in a)
            if (xe(a, o)) {
    ...
    Oh = (e, t, n, o, r) => {
      ...
      if (s && yo(t))
        for (let n = 0; n < s.length; n++) {
          const i = s[n];
          if (Rh(e.dom, t, i) && Ah(a, t, i, 'attributes', r, o) && Ah(a, t, i, 'styles', r, o)) {
            const n = i.classes;
            if (n) for (let r = 0; r < n.length; r++) if (!e.dom.hasClass(t, Tu(n[r], o))) return;
            return i;
          }
        }
    },
    ...
    Lh = (e) => {
      const t = cn('span');
      return qt(t, { id: Uc, 'data-mce-bogus': '1', 'data-mce-type': 'format-caret' }), e && Jn(t, un(Bh)), t;
    },
    Mh = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
      if (Dh(t)) gp(e, !1, mn(t), n);
        ...
        o.remove(t, !0), s === d && a > 0 && e.setStart(d, a - 1), i === d && l > 0 && e.setEnd(d, l - 1), n && o.isEmpty(n) && kr(mn(n)), r.setRng(e);
      }
    },
    Ih = (e, t, n = !0) => {
      const o = e.dom,
        r = e.selection;
      if (t) Mh(e, t, n);
      else if (!(t = jc(e.getBody(), r.getStart()))) for (; (t = o.get(Uc));) Mh(e, t, !1);
    },
    ...
    zh = (e, t, n, o) => {
      ...
      if (h)
        if (l) {
          ...
          l && Mh(e, l, !1), i.setCursorLocation(u, 1), a.isEmpty(h) && a.remove(h);
        }
    },
    jh = (e, t) => {
      const n = e.schema.getTextInlineElements();
  ...
  const Vh = ['fontWeight', 'fontStyle', 'color', 'fontSize', 'fontFamily'],
    qh = (e, t) => {
      const n = e.get(t);
      return p(n) ? Q(n, (e) => zu(e) && 'span' === e.inline && ((e) => f(e.styles) && H(ue(e.styles), (e) => j(Vh, e)))(e)) : M.none();
    },
    Wh = (e, t) => Mc(t, ai.fromRangeStart(e)).isNone(),
    Kh = (e, t) => !1 === Lc(t, ai.fromRangeEnd(e)).exists((e) => !Po(e.getNode()) || Lc(t, e).isSome()),
    ...
    db = (e, t, n) => {
      ...
      return Ro(o) && n && r >= o.data.length && (o = new Zo(o, e.getBody()).next() || o), Ro(o) && !n && 0 === r && (o = new Zo(o, e.getBody()).prev() || o), o;
    },
    cb = (e, t) => {
    ...
    fb = (e, t, n) => (x(e) ? { name: t, value: null } : { name: e, value: Tu(t, n) }),
    gb = (e, t) => {
    ...
    pb = (e, t, n, o, r) => {
      ...
      ab(n.styles, (a, i) => {
        const { name: l, value: d } = fb(i, a, o),
          c = Du(d, l);
        (n.remove_similar || h(d) || !yo(r) || ib(Pu(e, r, l), c)) && e.setStyle(t, l, ''), (s = !0);
      }),
        s && gb(e, t);
    },
    hb = (e, t, n, o, r) => {
      const s = e.dom,
        a = nh(e);
      if (!t.ceFalseOverride && o && 'false' === s.getContentEditableParent(o)) return rb.keep();
      if (o && !Rh(s, o, t) && !((e, t) => t.links && 'A' === e.nodeName)(o, t)) return rb.keep();
      const i = o,
        l = t.preserve_attributes;
      if (zu(t) && 'all' === t.remove && p(l)) {
        const e = K(s.getAttribs(i), (e) => j(l, e.name.toLowerCase()));
        if ((s.removeAllAttribs(i), V(e, (e) => s.setAttrib(i, e.name, e.value)), e.length > 0)) return rb.rename('span');
      }
      if ('all' !== t.remove) {
        pb(s, i, t, n, r),
          ab(t.attributes, (e, o) => {
            const { name: a, value: l } = fb(o, e, n);
            if (t.remove_similar || h(l) || !yo(r) || ib(s.getAttrib(r, a), l)) {
              if ('class' === a) {
              ...
              if ((sb.test(a) && i.removeAttribute('data-mce-' + a), 'style' === a && wo(['li'])(i) && 'none' === s.getStyle(i, 'list-style-type'))) return i.removeAttribute(a), void s.setStyle(i, 'list-style-type', 'none');
              'class' === a && i.removeAttribute('className'), i.removeAttribute(a);
            }
          }),
          ab(t.classes, (e) => {
        ...
        ? (((e, t, n) => {
          ...
          Fu(n) &&
            ...
            ((n.list_block && ib(t, n.list_block)) ||
              V(de(t.childNodes), (t) => {
                Ru(e, a, t.nodeName.toLowerCase()) ? (r ? r.appendChild(t) : ((r = ub(s, t, a)), s.setAttribs(r, Zi(e)))) : (r = null);
              })),
            (((e) => Uu(e) && zu(e) && Bt(we(e, 'mixed'), !0))(n) && !ib(n.inline, t)) || s.remove(t, !0);
        })(e, i, t),
          rb.removed())
        : rb.keep();
    },
    bb = (e, t, n, o, r) => hb(e, t, n, o, r).fold(P, (t) => (e.dom.rename(o, t), !0), L),
    vb = (e, t, n, o) => hb(e, t, n, o, o).fold(N(o), (t) => (e.dom.createFragment().appendChild(o), e.dom.rename(o, t)), N(null)),
    yb = (e, t, n, o, r) => {
      const s = e.formatter.get(t),
          ...
          return ((e, t, n, o, r, s, a, i) => {
            ...
            if (n) {
              ...
              for (let n = o.parentNode; n && n !== s; n = n.parentNode) {
                let o = m.clone(n, !1);
                for (let n = 0; n < t.length && ((o = vb(e, t[n], i, o)), null !== o); n++);
                o && (c && o.appendChild(c), u || (u = o), (c = o));
              }
              (a.mixed && m.isBlock(n)) || (o = null !== (l = m.split(n, o)) && void 0 !== l ? l : o), c && u && (null === (d = r.parentNode) || void 0 === d || d.insertBefore(c, r), u.appendChild(r), zu(a) && eb(e, a, 0, c));
            }
            return o;
          })(e, s, i, o, o, 0, a, n);
        },
        ...
        u = (t) => {
          const n = de(t.childNodes),
            ...
            r = t.parentNode;
          if ((!o && C(r) && ju(a) && c(r), a.deep && n.length)) for (let e = 0; e < n.length; e++) u(n[e]);
          V(['underline', 'line-through', 'overline'], (n) => {
            yo(t) && e.dom.getStyle(t, 'text-decoration') === n && t.parentNode && Lu(i, t.parentNode) === n && bb(e, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: n } }, void 0, t);
          });
        },
        m = (e) => {
          ...
          if (t) {
            ...
            return (
              ((e) => Zc(e) && yo(e) && ('_start' === e.id || '_end' === e.id))(n) && (n = n[e ? 'firstChild' : 'lastChild']),
          ...
          if (a.split) {
            if (((r = Gm(r)), (n = db(e, r, !0)), (o = db(e, r)), n !== o)) {
              if (((n = cb(n, !0)), (o = cb(o, !1)), lb(i, n, o))) {
                ...
                return d(mb(i, e, !0, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), void m(!0);
              }
              if (lb(i, o, n)) {
                const e = M.from(o.lastChild).getOr(o);
                return d(mb(i, e, !1, 'span', { id: '_end', 'data-mce-type': 'bookmark' })), void m(!1);
              }
              (n = ub(i, n, 'span', { id: '_start', 'data-mce-type': 'bookmark' })), (o = ub(i, o, 'span', { id: '_end', 'data-mce-type': 'bookmark' }));
              const e = i.createRng();
              e.setStartAfter(n),
                e.setEndBefore(o),
                om(i, e, (e) => {
    ...
    kb = (e, t, n, o) => {
      const r = e.formatter.get(t),
        ...
        c = (e, t) => {
          let n = !1;
          return wb(e, (e) => !(!Uu(e) || (('false' !== i.getContentEditable(t) || e.ceFalseOverride) && (!C(e.collapsed) || e.collapsed === a) && i.is(t, e.selector) && !zc(t) && (d(t, e), (n = !0), 1)))), n;
        },
        u = (e) => {
          if (m(e)) {
            const t = i.create(e);
        ...
        f = (o, a, i) => {
          ...
          om(o, a, (a) => {
            ...
            const p = (a) => {
              ...
              if (((o) => ((e) => Fu(e) && !0 === e.wrapper)(s) && Oh(e, o, t, n))(a)) u = null;
              else {
                if (
                  ((t, n, o) => {
                    const r = ((e) => Fu(e) && !0 !== e.wrapper)(s) && Nu(e, t) && Ru(e, n, f);
                    return o && r;
                  })(y, x, S)
                ) {
                ...
                if (Uu(s)) {
                  let e = c(r, a);
                  if ((!e && C(w) && ju(s) && (e = c(r, w)), !zu(s) || e)) return void (u = null);
                }
                C(g) &&
                  ((t, n, r, a) => {
                  ...
                  ? (u || ((u = o.clone(g, !1)), w.insertBefore(u, a), l.push(u)), v && h && (m = b), u.appendChild(a))
                  : ((u = null), V(de(a.childNodes), p), h && (m = b), (u = null));
              }
            };
            V(a, p);
          }),
            ...
            V(l, (a) => {
              ...
              (!(l.length > 1) && o.isBlock(a)) || 0 !== i
                ...
                (s.exact ||
                  1 !== i ||
                  (a = ((e) => {
                    const t = Q(e.childNodes, xu).filter((e) => 'false' !== o.getContentEditable(e) && Rh(o, e, s));
                    return t
                      .map((t) => {
                        const n = o.clone(t, !1);
                  ...
                  ((e, t, n, o, r) => {
                    ...
                    (Oh(e, s, n, o) && bb(e, t, o, r)) || (t.merge_with_parents && s && e.dom.getParent(s, (s) => !!Oh(e, s, n, o) && (bb(e, t, o, r), !0)));
                  })(e, s, t, n, a),
                  ((e, t, n, o) => {
                    if (t.styles && t.styles.backgroundColor) {
                      const r = nb(e, 'fontSize');
                      tb(o, (e) => r(e) && ku(e), ob(e, 'backgroundColor', Tu(t.styles.backgroundColor, n)));
                    }
                  })(o, s, n, a),
                  ((e, t, n, o) => {
                    const r = (t) => {
                  ...
                  ((e, t, n, o) => {
                    if (zu(t) && ('sub' === t.inline || 'sup' === t.inline)) {
                      ...
                      const r = K(e.select('sup' === t.inline ? 'sub' : 'sup', o), ku);
                      e.remove(r, !0);
                    }
                  })(o, s, 0, a),
                  eb(e, s, 0, a))
        ...
        g = wu(o) ? o : l.getNode();
      if ('false' === i.getContentEditable(g) && !Ou(e, g)) return c(r, (o = g)), void mm(e, t, o, n);
      if (s) {
        if (o)
          if (wu(o)) {
            if (!c(r, o)) {
          ...
          a && zu(s) && !mu(e).length
            ? ((e, t, n) => {
              ...
              if (l && i > 0 && i < l.length && d.test(l.charAt(i)) && d.test(l.charAt(i - 1))) {
                ...
                let s = o ? Ph(o) : null;
                (o && (null == s ? void 0 : s.data) === Bh) || ((c = e.getDoc()), (u = Lh(!0).dom), (o = c.importNode(u, !0)), (s = o.firstChild), a.insertNode(o), (i = 1)), e.formatter.apply(t, n, o), r.setCursorLocation(s, i);
              }
              var c, u;
            })(e, t, n)
                ...
                ((e) =>
                  K(
                    ((e) => {
                      ...
                      if (1 === t.length) return Wh(n, t[0]) && Kh(n, t[0]) ? t : [];
                      {
                        const e = ie(t)
                          .filter((e) => Wh(n, e))
                          .toArray(),
      ...
      fe(n, (n, r) => {
        const s = (n) => {
          ...
          if (n.state.get() !== a) {
            n.state.set(a);
            const e = s.getOr(t);
            Sb(n) ? n.callback(a, { node: e, format: r, parents: o }) : V(n.callbacks, (t) => t(a, { node: e, format: r, parents: o }));
          }
        };
  ...
  var iv = zb([
    ...
    mv = zb(['maction', 'maligngroup', 'malignmark', 'mlongdiv', 'mscarries', 'mscarry', 'msgroup', 'mstack', 'msline', 'msrow', 'semantics', 'annotation', 'annotation-xml', 'mprescripts', 'none']),
    fv = zb(['#text']),
    gv = zb([
      'accept',
      'action',
    ...
    bv = zb(['xlink:href', 'xml:id', 'xlink:title', 'xml:space', 'xmlns:xlink']),
    vv = jb(/\{\{[\w\W]*|[\w\W]*\}\}/gm),
    yv = jb(/<%[\w\W]*|[\w\W]*%>/gm),
    Cv = jb(/^data-[\-\w.\u00B7-\uFFFF]/),
    wv = jb(/^aria-[\-\w]+$/),
    xv = jb(/^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp):|[^a-z]|[a-z+.\-]+(?:[^a-z+.\-:]|$))/i),
    ...
    Rv = (function e() {
      var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Ev(),
        n = function (t) {
          return e(t);
        };
      ...
      var T,
        ...
        ue = null,
        me = rv({}, ['alt', 'class', 'for', 'id', 'label', 'name', 'pattern', 'placeholder', 'role', 'summary', 'title', 'value', 'style', 'xmlns']),
        ...
        ke = function (e) {
          (Ce && Ce === e) ||
            ((e && 'object' === Ab(e)) || (e = {}),
              ...
              (ue = 'ADD_URI_SAFE_ATTR' in e ? rv(sv(me), e.ADD_URI_SAFE_ATTR) : me),
              (de = 'ADD_DATA_URI_TAGS' in e ? rv(sv(ce), e.ADD_DATA_URI_TAGS) : ce),
              ...
              e.FORBID_CONTENTS && (ie === le && (ie = sv(ie)), rv(ie, e.FORBID_CONTENTS)),
              re && (z['#text'] = !0),
      ...
      var Ae = function (e) {
        ...
        Ie = function (e) {
          ...
          var o = B(e.nodeName);
          if (
            (Me('uponSanitizeElement', e, { tagName: o, allowedTags: z }), e.hasChildNodes() && !Le(e.firstElementChild) && (!Le(e.content) || !Le(e.content.firstElementChild)) && tv(/<[/\w]/g, e.innerHTML) && tv(/<[/\w]/g, e.textContent))
          )
            return Oe(e), !0;
          if ('select' === o && tv(/<template/i, e.innerHTML)) return Oe(e), !0;
          if (!z[o] || q[o]) {
            if (!q[o] && Ue(o)) {
              if (V.tagNameCheck instanceof RegExp && tv(V.tagNameCheck, o)) return !1;
          ...
          return e instanceof l && !Ae(e)
            ? (Oe(e), !0)
            : ('noscript' !== o && 'noembed' !== o) || !tv(/<\/no(script|embed)/i, e.innerHTML)
              ? (X && 3 === e.nodeType && ((t = e.textContent), (t = Jb(t, D, ' ')), (t = Jb(t, P, ' ')), e.textContent !== t && (Yb(n.removed, { element: e.cloneNode() }), (e.textContent = t))), Me('afterSanitizeElements', e, null), !1)
              : (Oe(e), !0);
        },
        Fe = function (e, t, n) {
          ...
          if (G && !W[t] && tv(L, t));
            ...
            if (
              !(
                (Ue(e) &&
                  ((V.tagNameCheck instanceof RegExp && tv(V.tagNameCheck, e)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(e))) &&
                  ((V.attributeNameCheck instanceof RegExp && tv(V.attributeNameCheck, t)) || (V.attributeNameCheck instanceof Function && V.attributeNameCheck(t)))) ||
                ('is' === t && V.allowCustomizedBuiltInElements && ((V.tagNameCheck instanceof RegExp && tv(V.tagNameCheck, n)) || (V.tagNameCheck instanceof Function && V.tagNameCheck(n))))
              )
            )
              return !1;
          } else if (ue[t]);
          else if (tv(U, Jb(n, F, '')));
          else if (('src' !== t && 'xlink:href' !== t && 'href' !== t) || 'script' === e || 0 !== Zb(n, 'data:') || !de[e])
            if (Y && !tv(I, Jb(n, F, '')));
            else if (n) return !1;
          return !0;
        },
      ...
      return (
        (n.sanitize = function (e, r) {
          ...
          if (((be = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !Le(e))) {
            if ('function' != typeof e.toString) throw nv('toString is not a function');
            if ('string' != typeof (e = e.toString())) throw nv('dirty is not a string, aborting');
          }
          if (!n.isSupported) {
          ...
          if ((J || ke(r), (n.removed = []), 'string' == typeof e && (se = !1), se)) {
            if (e.nodeName) {
              var m = B(e.nodeName);
              if (!z[m] || q[m]) throw nv('root node is forbidden and cannot be sanitized in-place');
            }
          ...
          return (
            Q && z['!doctype'] && a.ownerDocument && a.ownerDocument.doctype && a.ownerDocument.doctype.name && tv(_v, a.ownerDocument.doctype.name) && (g = '<!DOCTYPE ' + a.ownerDocument.doctype.name + '>\n' + g),
            X && ((g = Jb(g, D, ' ')), (g = Jb(g, P, ' '))),
  ...
  const Av = Tt.explode,
    ...
    Tv = (e, t, n) => {
      ...
      t.convert_fonts_to_spans &&
        ...
        })(e, r, Tt.explode(null !== (o = t.font_size_legacy_values) && void 0 !== o ? o : '')),
        ((e, t, n) => {
  ...
  const Mv = (e, t, n) =>
    ...
    Fv = (e, t, n = !1) => Mv(t, n, (t, n) => M.from(e.getByData(t, n)).orThunk(() => Dv(n, t).map((n) => Iv(e, n, t)))),
    Uv = Tt.each,
    zv = Tt.trim,
    jv = ['source', 'protocol', 'authority', 'userInfo', 'user', 'password', 'host', 'port', 'relative', 'path', 'directory', 'file', 'query', 'anchor'],
    ...
    Vv = (e, t, n) => {
      ...
      return (
        !e.allow_script_urls &&
        (!!/((java|vb)script|mhtml):/i.test(o) || (!e.allow_html_data_urls && (/^data:image\//i.test(o) ? ((e, t) => (C(e) ? !e : !C(t) || !j($v, t)))(e.allow_svg_data_urls, n) && /^data:image\/svg\+xml/i.test(o) : /^data:/i.test(o))))
      );
    };
  class qv {
    constructor(e, t = {}) {
  ...
  const Wv = Tt.makeMap,
    Kv = Tt.extend,
    Gv = { IN_PLACE: !0, ALLOW_UNKNOWN_PROTOCOLS: !0, ALLOWED_TAGS: ['#comment', '#cdata-section', 'body'], ALLOWED_ATTR: [] },
    Yv = Tt.makeMap('src,href,data,background,action,formaction,poster,xlink:href'),
    Xv = 'data-mce-type',
    Qv = (e, t) => {
      const n = Rv(),
        ...
        n.addHook('uponSanitizeElement', (n, a) => {
          ...
          if (!r || h) {
            if (((a.allowedTags[c] = !0), r && h && !g)) {
              if (
                (V(null !== (l = h.attributesForced) && void 0 !== l ? l : [], (e) => {
                  ...
                  h.attributesRequired && !H(h.attributesRequired, (e) => Gt(u, e)))
              )
                return void no(u);
              if (
                h.removeEmptyAttrs &&
        ...
        n.addHook('uponSanitizeAttribute', (n, o) => {
          ...
          (o.keepAttr = !r || t.isValid(s, a) || ze(a, 'data-') || ze(a, 'aria-')),
            ...
            o.keepAttr
              ...
              : !n.hasAttribute(Xv) || ('id' !== a && 'class' !== a && 'style' !== a) || (o.forceKeepAttr = !0);
        }),
        n
      );
    },
          ...
          parse: (e, n = {}) => {
            ...
            const [f, g] = ((e, t, n, o) => {
              const r = n.validate,
                ...
                i = Kv(Wv('script,style,head,html,body,title,meta,param'), t.getBlockElements()),
                l = Ds(t),
                d = /[ \t\r\n]+/g,
                c = /^[ \t\r\n]+/,
                u = /[ \t\r\n]+$/,
                ...
                f = (t, n) => {
                  ...
                  return !C(r) && !y(t.parent) && t.parent.name in i && (t.parent !== e || !0 === o.isRootContent);
                };
              return [
                (e) => {
                  var t;
                  if (3 === e.type && !m(e)) {
                    ...
                    (n = n.replace(d, ' ')), (((e, t) => C(e) && (e.name in t || 'br' === e.name))(e.prev, i) || f(e, !0)) && (n = n.replace(c, '')), 0 === n.length ? e.remove() : (e.value = n);
                  }
                },
                (e) => {
                  var n;
                      ...
                      n.paddInEmptyBlock &&
                        ...
                        : n.removeEmpty && r
                          ...
                          (r ||
                            ((e) => {
                              var t;
                              return ih(e, '#text') && (null === (t = null == e ? void 0 : e.firstChild) || void 0 === t ? void 0 : t.value) === pr;
                            })(e)) &&
                          ah(0, o, i, e);
                    }
                  } else if (3 === e.type && !m(e)) {
                    let t = null !== (n = e.value) && void 0 !== n ? n : '';
                    ((e.next && i[e.next.name]) || f(e, !1)) && (t = t.replace(u, '')), 0 === t.length ? e.remove() : (e.value = t);
                  }
                },
              ];
            })(m, t, r, n),
            ...
            return (
              ...
              ((e, n) => {
                const o = Kv(Wv('script,style,head,html,body,title,meta,param'), t.getBlockElements()),
                  s = /^[ \t\r\n]+/,
                  a = /[ \t\r\n]+$/;
                let i = e.firstChild,
                  l = null;
                ...
                if (t.isValidChild(e.name, n.toLowerCase())) {
                  for (; i;) {
                    const t = i.next;
                    3 === i.type || (1 === i.type && 'p' !== i.name && !o[i.name] && !i.attr(Xv)) ? (l || ((l = new Zf(n, 1)), l.attr(r.forced_root_block_attrs), e.insert(l, i)), l.append(i)) : (d(l), (l = null)), (i = t);
                  }
                  d(l);
                }
              })(m, w),
              ...
              for (let t = 0, i = e.length; t < i; t++) {
                ...
                if (l && r[l.name] && i === l.lastChild) {
                  ...
                  if (i && (i.remove(), lh(n, s, a, l))) {
                    ...
                    e && (e.removeEmpty ? l.remove() : e.paddEmpty && ah(0, o, r, l));
                  }
                } else {
                  let e = i;
    ...
    ey = (e, t) => {
      ...
      if (Ch(e)) {
        if (o.content !== n) {
          const t = Zv({ validate: !1, forced_root_block: !1 }).parse(o.content, { context: e.name });
          return { ...o, content: t };
        }
        return { ...o, content: e };
      }
    ...
    ty = (e, t) => {
      if (t.no_events) return Oi.value(t);
      {
        ...
        return n.isDefaultPrevented() ? Oi.error(pm(e, { content: '', ...n }).content) : Oi.value(n);
      }
    },
    ny = (e, t, n) => (n.no_events ? t : ey(t, (t) => pm(e, { ...n, content: t })).content),
    oy = (e, t) => {
      if (t.no_events) return Oi.value(t);
      {
        const n = ey(t.content, (n) => ((e, t) => e.dispatch('BeforeSetContent', t))(e, { ...t, content: n }));
        return n.isDefaultPrevented() ? (gm(e, n), Oi.error(void 0)) : Oi.value(n);
      }
    },
    ry = (e, t, n) => {
    ...
    uy = (e, t) => {
      ...
      for (let e = 0; e < n.length; e++) {
        const o = n[e].cells;
        for (let n = 0; n < o.length; n++) if (bn(o[n], t)) return M.some(iy(n, e));
      }
      return M.none();
    },
    my = (e, t, n, o, r) => {
                ...
                V(vr(e, 'tr'), (e, n) => {
                  V(vr(e, 'td,th'), (o, r) => {
                    ((e, t, n, o, r) => {
                      ...
                      for (let e = n; e < n + s; e++) {
                        i[e] || (i[e] = ay(Aa(o), []));
                        for (let o = t; o < t + a; o++) i[e].cells[o] = e === n && o === t ? r : Ra(r);
                      }
                    })(
                      t,
                      ((e, t, n) => {
    ...
    yy = (e) => Nr(e.innerText),
    Cy = (e) => (yo(e) ? e.outerHTML : Ro(e) ? xs.encodeRaw(e.data, !1) : To(e) ? '\x3c!--' + e.data + '--\x3e' : ''),
    wy = (e, t) => (
      ((e, t) => {
        let n = 0;
        V(e, (e) => {
    ...
    ky = (e) => {
      const t = ((n = e.getBody()), K($(de(n.childNodes), Cy), (e) => e.length > 0));
      var n;
      const o = ee(t, (t) => {
    ...
    Sy = (e, t, n) => {
      ...
      'fragmented' === t.type ? wy(t.fragments, e.getBody()) : e.setContent(t.content, { format: 'raw', no_selection: !C(o) || !$c(o) || !o.isFakeCaret }), o && e.selection.moveToBookmark(o);
    },
    ...
    Ny = (e, t) => !(!e || !t) && (!!((e, t) => _y(e) === _y(t))(e, t) || ((e, t) => Ey(e) === Ey(t))(e, t)),
    Ry = (e) => 0 === e.get(),
    Ay = (e, t, n) => {
      Ry(n) && (e.typing = t);
    },
    ...
    Ty = (e) => ({
      ...
      undoManager: {
        ...
        add: (t, n, o, r, s, a) =>
          ((e, t, n, o, r, s, a) => {
            ...
            (l.bookmark = Ni(e.selection)), n.get() < t.data.length - 1 && (t.data.length = n.get() + 1), t.data.push(l), n.set(t.data.length - 1);
        ...
        undo: (t, n, o) =>
          ((e, t, n, o) => {
            let r;
            return t.typing && (t.add(), (t.typing = !1), Ay(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), (r = t.data[o.get()]), Sy(e, r, !0), e.setDirty(!0), e.dispatch('Undo', { level: r })), r;
          })(e, t, n, o),
        redo: (t, n) =>
          ((e, t, n) => {
            let o;
            return t.get() < n.length - 1 && (t.set(t.get() + 1), (o = n[t.get()]), Sy(e, o, !1), e.setDirty(!0), e.dispatch('Redo', { level: o })), o;
          })(e, t, n),
        clear: (t, n) =>
          ((e, t, n) => {
        ...
        hasUndo: (t, n) => ((e, t, n) => n.get() > 0 || (t.typing && t.data[0] && !Ny(ky(e), t.data[0])))(e, t, n),
        hasRedo: (e, t) => ((e, t) => t.get() < e.data.length - 1 && !e.typing)(e, t),
        transact: (e, t, n) => ((e, t, n) => (Oy(e, t), e.beforeChange(), e.ignore(n), e.add()))(e, t, n),
        ignore: (e, t) =>
          ((e, t) => {
            try {
              e.set(e.get() + 1), t();
          ...
          ((e, t, n, o, r) => {
            if (t.transact(o)) {
              const o = t.data[n.get()].bookmark,
                s = t.data[n.get() - 1];
              Sy(e, s, !0), t.transact(r) && (t.data[n.get() - 1].beforeBookmark = o);
            }
          })(e, t, n, o, r),
      },
      formatter: {
        ...
        closest: (t) =>
          ((e, t) => {
            ...
            return M.from(e.selection.getStart(!0))
              .bind((o) => Sh(mn(o), (n) => ce(t, (t) => ((t, n) => (Oh(e, t.dom, n) ? M.some(n) : M.none()))(n, t)), n))
              .getOrNull();
          })(e, t),
        ...
        toggle: (t, n, o) =>
          ((e, t, n, o) => {
            const r = e.formatter.get(t);
            r && (!Th(e, t, n, o) || ('toggle' in r[0] && !r[0].toggle) ? kb(e, t, n, o) : yb(e, t, n, o));
          })(e, t, n, o),
            ...
            ((e, t, n, o, r, s) => {
              ...
              V(n.split(','), (t) => {
                const n = we(a, t).getOrThunk(() => {
                  const e = { withSimilar: { state: ra(!1), similar: !0, callbacks: [] }, withoutSimilar: { state: ra(!1), similar: !1, callbacks: [] }, withVars: [] };
                  return (a[t] = e), e;
                }),
                  i = () => {
                    const n = Nb(e);
                ...
                } else n.withVars.push({ state: ra(i()), similar: r, vars: s, callback: o });
              }),
                t.set(a);
            })(e, t, n, o, r, s),
            {
      ...
      editor: {
        getContent: (t) => ((e, t) => M.from(e.getBody()).fold(N('tree' === t.format ? new Zf('body', 11) : ''), (n) => rg(e, t, n)))(e, t),
        setContent: (t, n) =>
          ((e, t, n) =>
            M.from(e.getBody())
              .map((o) =>
                Ch(t)
                  ...
                  : ((e, t, n, o) => {
                    if (0 === n.length || /^\s+$/.test(n)) {
                      ...
                      const s = Ji(e);
                      return e.schema.isValidChild(t.nodeName.toLowerCase(), s.toLowerCase()) ? ((n = r), (n = e.dom.createHTML(s, Zi(e), n))) : n || (n = r), wh(e, n, o.no_selection), { content: n, html: n };
                    }
                    {
                      'raw' !== o.format && (n = ig({ validate: !1 }, e.schema).serialize(e.parser.parse(n, { isRootContent: !0, insert: !0 })));
                      const r = cr(mn(t)) ? n : Tt.trim(n);
                      return wh(e, r, o.no_selection), { content: r, html: r };
                    }
                  })(e, o, t, n)
              )
              .getOr({ content: t, html: Ch(n.content) ? '' : n.content }))(e, t, n),
                        ...
                        const o = M.from(e.dom.getParent(t.commonAncestorContainer, e.dom.isBlock)),
                          ...
                          s = ((e) =>
                            e
                              ...
                              .getOr('div')
                              .toLowerCase())(o),
                          a = e.dom.add(r, s, { 'data-mce-bogus': 'all', style: 'overflow: hidden; opacity: 0;' }, t.cloneContents()),
                          i = yy(a),
                          l = Nr(null !== (n = a.textContent) && void 0 !== n ? n : '');
                        if ((e.dom.remove(a), vy(l, 0) || vy(l, l.length - 1))) {
                          const e = o.getOr(r),
                            t = yy(e),
                            n = t.indexOf(i);
                          return -1 === n ? i : (vy(t, n - 1) ? ' ' : '') + i + (vy(t, n + i.length) ? ' ' : '');
                        }
                        return i;
                      })
                      .getOr(''))(e);
                {
                  const n = ((e, t) => {
                    const n = e.selection.getRng(),
                      ...
                      s = $f(e, cu(r)),
                      a = t.contextual ? by(mn(e.getBody()), s).dom : n.cloneContents();
        ...
        (e) => (
          ...
          t.filter(Ut).map((t) =>
            ((e, t, n, o) => {
              ...
              o ? (ap(r, s, !1, !o), n.setStart(s, a)) : (ap(s, r, !1, !o), n.setEnd(s, a));
            })(e, t, n, o)
          )
        )
      ).orThunk(() => {
        const e = ((e, t) => e.filter((e) => dm.isBookmarkNode(e.dom)).bind(t ? Sn : kn))(t, o).or(t).filter(Ut);
        return e.map((e) =>
          ((e, t) => {
            xn(e).each((n) => {
              const o = e.dom;
              t && Yg(n, ai(o, 0)) ? rp(o, 0) : !t && Xg(n, ai(o, o.length)) && sp(o, o.length);
            });
          })(e, o)
        );
      });
  ...
  const Uy = (e) => !(!e || !e.ownerDocument) && vn(mn(e.ownerDocument), mn(e)),
      ...
      const { selectorChangedWithUnbind: a } = ((e, t) => {
        ...
        c = () => {
          ...
          if (C(o.bookmark) && !If(o)) {
            const e = Nf(o);
            if (e.isSome()) return e.map((e) => $f(o, [e])[0]).getOr(i.createRange());
          }
          try {
            const e = d();
            e && !vo(e.anchorNode) && ((n = e.rangeCount > 0 ? e.getRangeAt(0) : i.createRange()), (n = $f(o, [n])[0]));
          } catch (e) { }
          if ((n || (n = i.createRange()), Bo(n.startContainer) && n.collapsed)) {
            const t = e.getRoot();
        ...
        u = (e, t) => {
          if (!((e) => !!e && Uy(e.startContainer) && Uy(e.endContainer))(e)) return;
          const n = d();
        ...
        f = {
          ...
          setCursorLocation: (t, n) => {
            const r = e.createRng();
            C(t) && C(n) ? (r.setStart(t, n), r.setEnd(t, n), u(r), l(!1)) : (bu(e, r, o.getBody(), !0), u(r));
          },
          getContent: (e) => ((e, t = {}) => ((e, t, n) => Py(e).selection.getContent(t, n))(e, t.format ? t.format : 'html', t))(o, e),
          setContent: i,
              ...
              M.from(t).bind((t) =>
                M.from(t.parentNode).map((o) => {
                  const r = e.nodeIndex(t),
                    s = e.createRng();
                  return s.setStart(o, r), s.setEnd(o, r + 1), n && (bu(e, s, t, !0), bu(e, s, t, !1)), s;
                })
              ))(e, t, n).each(u),
            t
          ),
            ...
            ((e, t) => {
              ...
              t.collapsed ||
                (n === o && s - r < 2 && n.hasChildNodes() && (a = n.childNodes[r]),
                  Ro(n) && Ro(o) && ((n = n.length === r ? Hf(n.nextSibling, !0) : n.parentNode), (o = 0 === s ? Hf(o.previousSibling, !1) : o.parentNode), n && n === o && (a = n)));
          ...
          getBoundingClientRect: () => {
            const e = c();
            return e.collapsed ? ai.fromRangeStart(e).getClientRects()[0] : e.getBoundingClientRect();
          },
          destroy: () => {
          ...
          e.addAttributeFilter('data-mce-tabindex', (e, t) => {
            ...
            e.addNodeFilter('noscript', (e) => {
              ...
              for (; n--;) {
                ...
                o && (o.value = xs.decode(null !== (t = o.value) && void 0 !== t ? t : ''));
              }
            }),
    ...
    Vy = (e, t, n = {}) => {
      ...
      return oy(e, o)
        .map((t) => {
          const n = ((e, t, n) => Dy(e).editor.setContent(t, n))(e, t.content, t);
    ...
    Wy = 'bbcode,colorpicker,contextmenu,fullpage,legacyoutput,spellchecker,textcolor'.split(','),
    Ky = (e) => {
    ...
    mC = (e, t, n) => (n ? `Failed to load ${e}: ${n} from url ${t}` : `Failed to load ${e} url: ${t}`),
    fC = (e, ...t) => {
                      ...
                      : ((o = t),
                        ze(o, 'blob:')
                          ...
                          : ze(o, 'data:')
                            ...
                            : Promise.reject('Unknown URI format')).then((t) => Pv(t).then((o) => Mv(o, !1, (n) => M.some(Iv(e, t, n))).getOrThunk(n)));
                  }
                  var o, r;
                  return ze(t, 'data:') ? Fv(e, t).fold(n, (e) => Promise.resolve(e)) : Promise.reject('Unknown image data format');
                })(t, o)
  ...
  const yC = (e, t) => {
    ...
    CC = (e) => () => e.notificationManager.open({ text: e.translate('Image uploading...'), type: 'info', timeout: -1, progressBar: !0 }),
    wC = (e, t) => yC(t, { url: cl(e), basePath: ul(e), credentials: ml(e), handler: fl(e) }),
    xC = (e) => {
      const t = (() => {
        let e = [];
        const t = (e) => {
          ...
          return {
            ...
            filename: N(
              ...
              '.' +
              ((r = o.type),
                { 'image/jpeg': 'jpg', 'image/jpg': 'jpg', 'image/gif': 'gif', 'image/png': 'png', 'image/apng': 'apng', 'image/avif': 'avif', 'image/svg+xml': 'svg', 'image/webp': 'webp', 'image/bmp': 'bmp', 'image/tiff': 'tiff' }[
                r.toLowerCase()
                ] || 'dat')
            ),
            blob: N(o),
                      ...
                      n.status && il(e)
                        ? (n.url && !Ue(l.src, n.url) && (s = !0),
                          ...
                          ((t, n) => {
                            ...
                            var r;
                            d(t.src, n), qt(mn(t), { src: al(e) ? ((r = n), r + (-1 === r.indexOf('?') ? '?' : '&') + new Date().getTime()) : n, 'data-mce-src': o });
                          })(l, n.url))
                        : n.error &&
                        (n.error.remove && (d(l.src, Nt.transparentSrc), r.push(l), (c = !0)),
                          ((e, t) => {
                            cC(e, la.translate(['Failed to upload image: {0}', t]));
                          })(e, n.error.message)),
    ...
    _C = {
      tablecellbackgroundcolor: { styles: { backgroundColor: '%value' }, ...SC },
    ...
    OC = (e, t) => {
      const n = (t && t.schema) || Ls({}),
        o = (e) => {
          ...
          return (
            ((e, t) => {
              t.classes.length > 0 && RC.addClass(e, t.classes.join(' ')), RC.setAttribs(e, t.attrs);
            })(n, t),
            n
          );
        },
    ...
    BC = (e, t) => {
      ...
      const l =
        ((d = t.selector),
          m(d)
            ...
            : []);
      var d;
      l.length > 0 ? (l[0].name || (l[0].name = i), (i = t.selector), (a = OC(l, e))) : (a = OC([i], e));
      ...
      return (
        NC(o.split(' '), (e) => {
          let t = s(e, c);
          if (!(('background-color' === e && /transparent|rgba\s*\([^)]+,\s*0\)/.test(t) && ((t = s(e)), '#ffffff' === du(t).toLowerCase())) || ('color' === e && '#000000' === du(t).toLowerCase()))) {
    ...
    DC = (e) => {
                ...
                ? (p(o) || (o = [o]),
                  V(o, (e) => {
                    v(e.deep) && (e.deep = !Uu(e)),
                      ...
                      Uu(e) && zu(e) && ((e.mixed = !0), (e.block_expand = !0)),
        ...
        return (
          n(
            ((e) => {
              ...
              return (
                Tt.each('p h1 h2 h3 h4 h5 h6 div address pre dt dd samp'.split(/\s/), (e) => {
      ...
      return (
        ...
        ((e) => {
          e.on('mouseup keydown', (t) => {
            ((e, t) => {
              const n = e.selection,
                o = e.getBody();
              Ih(e, null, !1), (8 !== t && 46 !== t) || !n.isCollapsed() || n.getStart().innerHTML !== Bh || Ih(e, jc(o, n.getStart())), (37 !== t && 39 !== t) || Ih(e, jc(o, n.getStart()));
            })(e, t.keyCode);
          });
        })(e),
        By(e) ||
        ...
        })(n, e),
        {
          ...
          match: (t, n, o, r) => ((e, t, n, o, r) => Py(e).formatter.match(t, n, o, r))(e, t, n, o, r),
          closest: (t) => ((e, t) => Py(e).formatter.closest(t))(e, t),
          matchAll: (t, n) => ((e, t, n) => Py(e).formatter.matchAll(t, n))(e, t, n),
          matchNode: (t, n, o, r) => ((e, t, n, o, r) => Py(e).formatter.matchNode(t, n, o, r))(e, t, n, o, r),
          canApply: (t) => ((e, t) => Py(e).formatter.canApply(t))(e, t),
          formatChanged: (t, o, r, s) => ((e, t, n, o, r, s) => Py(e).formatter.formatChanged(t, n, o, r, s))(e, n, t, o, r, s),
          getCssText: O(BC, e),
        }
      );
    },
    ...
    LC = (e) => {
      const t = ua(),
        ...
        r = {
          ...
          add: (s, a) => ((e, t, n, o, r, s, a) => Py(e).undoManager.add(t, n, o, r, s, a))(e, r, o, n, t, s, a),
          dispatchChange: () => {
            e.setDirty(!0);
            const t = ky(e);
            (t.bookmark = Ni(e.selection)), e.dispatch('change', { level: t, lastLevel: ae(r.data, o.get()).getOrUndefined() });
          },
          undo: () => ((e, t, n, o) => Py(e).undoManager.undo(t, n, o))(e, r, n, o),
          ...
          hasUndo: () => ((e, t, n) => Py(e).undoManager.hasUndo(t, n))(e, r, o),
          hasRedo: () => ((e, t, n) => Py(e).undoManager.hasRedo(t, n))(e, r, o),
          transact: (t) => ((e, t, n, o) => Py(e).undoManager.transact(t, n, o))(e, r, n, t),
          ignore: (t) => {
            ((e, t, n) => {
            ...
            e.on('keyup', (n) => {
              ...
              n.isDefaultPrevented() ||
                (((s >= 33 && s <= 36) || (s >= 37 && s <= 40) || 45 === s || n.ctrlKey) && (r(), e.nodeChanged()),
                  ...
                  o.get() && t.typing && !Ny(ky(e), t.data[0]) && (e.isDirty() || e.setDirty(!0), e.dispatch('TypingUndo'), o.set(!1), e.nodeChanged()));
            }),
            e.on('keydown', (e) => {
              const s = e.keyCode;
    ...
    MC = [9, 27, bm.HOME, bm.END, 19, 20, 44, 144, 145, 33, 34, 45, 16, 17, 18, 91, 92, 93, bm.DOWN, bm.UP, bm.LEFT, bm.RIGHT].concat(Nt.browser.isFirefox() ? [224] : []),
                    ...
                    jC(e, n).map((n) =>
                      ((e, t, n) =>
                        Po(n.position.getNode()) && !ss(n.block)
                          ? Pc(!1, n.block.dom)
                            .bind((o) => (o.isEqual(n.position) ? Tc(t, e, o).bind((t) => jC(e, t)) : M.some(n)))
                            .getOr(n)
                          : n)(e, t, n)
                    )
                  )
    ...
    JC = (e) => {
      ...
      return ((e, t) => {
        ...
        return !((e, t) => QC(e, t.startContainer) || QC(e, t.endContainer))(e, t) && n && o;
        ...
        : ((e, t) => {
          const n = t.getRng();
          return Dt(Sp(e, mn(n.startContainer)), Sp(e, mn(n.endContainer)), (o, r) =>
            bn(o, r)
              ? M.none()
              : M.some(() => {
                n.deleteContents(),
    ...
    aw = (e, t) =>
      ((e, t) => {
        ...
        const c = s(d);
        return c && a(c) && pc(d, c) ? M.some(() => sw(e, n, i.getNode(), o, t, c)) : M.none();
      })(e, t),
    iw = (e, t) => {
      const n = e.getBody();
    ...
    lw = (e) => {
      ...
      return !t.collapsed && (iw(e, !0).exists((e) => e.isEqual(ai.fromRangeStart(t))) || iw(e, !1).exists((e) => e.isEqual(ai.fromRangeEnd(t))));
    },
    dw = Ti([{ remove: ['element'] }, { moveToElement: ['element'] }, { moveToPosition: ['position'] }]),
    cw = (e, t, n) =>
      Tc(t, e, n).bind((o) => {
        return (
          (r = o.getNode()),
                    ...
                    : t && Eg(r) && Ug(s, r)
                      ...
                      : ((e, t, n) =>
                        ((e, t) => {
                          ...
                          ? ((e, t) => (y(t) ? M.none() : e && Io(t.nextSibling) ? M.some(dw.moveToElement(t.nextSibling)) : !e && Io(t.previousSibling) ? M.some(dw.moveToElement(t.previousSibling)) : M.none()))(t, n.getNode(!t)).orThunk(() =>
                            cw(e, t, n)
                          )
                          : cw(e, t, n).bind((t) =>
                            ((e, t, n) =>
                              n.fold(
                                ...
                                (n) => (oc(t, n, e) ? M.none() : M.some(dw.moveToPosition(n)))
                              ))(e, n, t)
                          ))(e, t, r);
            })(e.getBody(), t, e.selection.getRng()).map(
              (n) => () =>
                n.fold(
                  ((e, t) => (n) => (e._selectionOverrides.hideFakeCaret(), gp(e, t, mn(n)), !0))(e, t),
                  ((e, t) => (n) => {
            ...
            ? uw(e, n.parentNode)
              ...
              .fold(
                () =>
                  M.some(() => {
                    var n;
                    (n = mn(e.getBody())), V(vr(n, '.mce-offscreen-selection'), to), gp(e, t, mn(e.selection.getNode())), _p(e);
                  }),
                () => M.some(S)
              )
            : lw(e)
    ...
    yw = (e) => {
      var t;
      return (null !== (t = e.ownerDocument) && void 0 !== t ? t : document).createTextNode(_r);
    },
    Cw = (e, t) =>
      e
        ? ((e) => {
          var t;
          if (hw(e.previousSibling)) return vw(e.previousSibling) || e.previousSibling.appendData(_r), e.previousSibling;
        ...
        : ((e) => {
          var t, n;
          if (hw(e.nextSibling)) return bw(e.nextSibling) || e.nextSibling.insertData(0, _r), e.nextSibling;
    ...
    ww = O(Cw, !0),
    xw = O(Cw, !1),
    kw = (e, t) => (Ro(e.container()) ? Cw(t, e.container()) : Cw(t, e.getNode())),
    Sw = (e, t) => {
      const n = t.get();
    ...
    Nw = Ti([{ before: ['element'] }, { start: ['element'] }, { end: ['element'] }, { after: ['element'] }]),
    Rw = (e, t) => nc(t, e) || e,
    Aw = (e, t, n) => {
      const o = yp(n),
        r = Rw(t, o.container());
    ...
    Bw = (e, t, n) => {
      const o = Cp(n);
      return Tw(e, t, o).bind((e) => (Mc(e, o).isNone() ? M.some(Nw.start(e)) : M.none()));
    },
    Dw = (e, t, n) => {
      const o = yp(n);
      return Tw(e, t, o).bind((e) => (Lc(e, o).isNone() ? M.some(Nw.end(e)) : M.none()));
    },
    Pw = (e, t, n) => {
      const o = Cp(n),
        r = Rw(t, o.container());
    ...
    Lw = (e) => {
      return (t = Iw(e)), !('rtl' === ta.DOM.getStyle(t, 'direction', !0) || ((e) => pp.test(e))(null !== (n = t.textContent) && void 0 !== n ? n : ''));
      var t, n;
    },
    ...
    $w = (e, t) => (e ? t.fold(_(M.some, Nw.start), M.none, _(M.some, Nw.after), M.none) : t.fold(M.none, _(M.some, Nw.before), M.none, _(M.some, Nw.end))),
    Vw = (e, t, n) => {
      const o = e ? 1 : -1;
      return t.setRng(ai(n.container(), n.offset() + o).toRange()), t.getSel().modify('move', e ? 'forward' : 'backward', 'word'), !0;
    };
  var qw;
  !(function (e) {
  ...
  const Ww = (e, t) => (e === hc.Backwards ? ne(t) : t),
    ...
    Gw = (e, t, n, o) => (Po(o.getNode(t === hc.Forwards)) ? qw.Br : !1 === oc(n, o) ? qw.Block : qw.Wrap),
    Yw = (e, t, n, o) => {
      const r = Nc(n);
      let s = o;
      const a = [];
      for (; s;) {
        const n = Kw(t, r, s);
        if (!n) break;
        if (Po(n.getNode(!1))) return t === hc.Forwards ? { positions: Ww(t, a).concat([n]), breakType: qw.Br, breakAt: M.some(n) } : { positions: Ww(t, a), breakType: qw.Br, breakAt: M.some(n) };
        if (n.isVisible()) {
          if (e(s, n)) {
            const e = Gw(0, t, s, n);
  ...
  const mx = (e, t, n, o, r, s) => {
    ...
    Cx = (e, t, n, o, r, s) => {
      ...
      const f = l(u);
      return f && d(f) && pc(u, f) ? ew(t, e, f.getNode(!a), a, !1) : m ? yx(e, u.toRange(), !1) : M.none();
    },
    wx = (e, t, n, o, r, s) => {
      ...
      if (((g = o(a) ? a.getNode() : r(a) ? a.getNode(!0) : Ua(n)), g)) {
        const n = ((e, t, n, o) => {
          ...
          const d = [];
          let c = 0;
          1 === e ? ((s = r.next), (a = Ia), (i = Ma), (l = ai.after(o))) : ((s = r.prev), (a = Ma), (i = Ia), (l = ai.before(o)));
          const u = px(l);
          do {
    ...
    Ax = (e, t, n) =>
      ...
      ((e, t) => {
        ...
        return !!((e) => w(e.selection.getSel().modify))(t) && (e && Pr(o) ? Vw(!0, t.selection, o) : !(e || !Lr(o)) && Vw(!1, t.selection, o));
      })(e, t),
    Ox = (e) => {
      const t = ra(null),
        n = O(hp, e);
      return (
        e.on('NodeChange', (o) => {
          Pl(e) &&
            (((e, t, n) => {
              const o = $(vr(mn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'), (e) => e.dom),
                r = K(o, e),
                s = K(n, e);
              ...
              ((e, t) => {
                ...
                if (e.selection.isCollapsed() && !e.composing && n) {
                  ...
                  ai.isTextPosition(o) && !((e) => Pr(e) || Lr(e))(o) && (Sx(e, Dd(n, o)), t.set(null));
                }
              })(e, t),
              ((e, t, n, o) => {
    ...
    Lx = (e, t, n, o) => {
      ...
      e.undoManager.ignore(() => {
        e.selection.setRng(
          ...
          xp(e),
          Mw(s, r, ai.fromRangeStart(e.selection.getRng())).map(zw).bind(Px(e, t)).each(D);
      }),
        e.nodeChanged();
    },
    Mx = (e, t, n) => {
      if (e.selection.isCollapsed() && Pl(e)) {
        ...
        return ((e, t, n, o) => {
          const r = ((e, t) => nc(t, e) || e)(e.getBody(), o.container()),
            ...
            a = Mw(s, r, o);
          return a
            .bind((e) => (n ? e.fold(N(M.some(zw(e))), M.none, N(M.some(Uw(e))), M.none) : e.fold(M.none, N(M.some(Uw(e))), M.none, N(M.some(zw(e))))))
            .map(Px(e, t))
            .getOrThunk(() => {
              const i = Bc(n, r, o),
                l = i.bind((e) => Mw(s, r, e));
        ...
        return !((e, t, n) =>
          Dt(Ic(n), Fc(n), (o, r) => {
            const s = vp(!0, o),
              a = vp(!1, r),
              i = vp(!1, t);
            return e ? Lc(n, i).exists((e) => e.isEqual(a) && t.isEqual(s)) : Mc(n, i).exists((e) => e.isEqual(s) && t.isEqual(a));
          }).getOr(!0))(t, o, n.dom) ||
          (zc((s = n).dom) && Dh(s.dom))
          ? M.none()
          : M.some(() =>
    ...
    $x = (e, t) => (e || 'table' === Lt(t) ? 'margin' : 'padding') + ('rtl' === Vn(t, 'direction') ? '-right' : '-left'),
    Vx = (e) => {
      const t = Wx(e);
      return (
        !e.mode.isReadOnly() &&
    ...
    qx = (e) => ar(e) || ir(e),
    Wx = (e) => {
      return K(((t = e.selection.getSelectedBlocks()), $(t, mn)), (e) => !qx(e) && !((e) => xn(e).exists(qx))(e) && Ko(e, (e) => Mo(e.dom) || Io(e.dom)).exists((e) => Mo(e.dom)));
      var t;
    },
    Kx = (e, t) => {
      var n, o;
    ...
    Xx = (e, t, n) => ce([Yx, gw, aw, (e, n) => Mx(e, t, n), XC, Jp, pw, jx, ZC, Ux], (t) => t(e, n)),
    Qx = (e, t) => {
      e.addCommand('delete', () => {
        ((e, t) => {
          Xx(e, t, !1).fold(() => {
    ...
    tk = (e, t) => {
      if (Ro(t)) {
        ...
        if (/^\s+$/.test(t.data) && (!t.nextSibling || Zx(e, t.nextSibling))) return !0;
      }
      return !1;
    },
    ...
    ok = (e) => {
      ...
      if (!o.isValidChild(u, c.toLowerCase()) || ((e, t, n) => H(Ng(mn(n), mn(t)), (t) => Zx(e, t.dom)))(r, a, s)) return;
      const m = n.getRng(),
      ...
      for (; v;)
        if (ek(r, v)) {
          ...
          i || ((i = nk(e)), a.insertBefore(i, v), (d = !0)), (l = v), (v = v.nextSibling), i.appendChild(l);
    ...
    ik = (e, t) => {
      t.hasAttribute('data-mce-caret') && (Fr(t), e.selection.setRng(e.selection.getRng()), e.selection.scrollIntoView(t));
    },
    lk = (e, t) => {
      const n = ((e) =>
        Yo(mn(e.getBody()), '*[data-mce-caret]')
          .map((e) => e.dom)
          .getOrNull())(e);
      if (n) return 'compositionstart' === t.type ? (t.preventDefault(), t.stopPropagation(), void ik(e, n)) : void (Dr(n) && (ik(e, n), e.undoManager.add()));
    },
    dk = Io,
    ck = (e, t, n) => {
    ...
    uk = (e, t) =>
      ((e, t) => {
        const n = t ? hc.Forwards : hc.Backwards,
          o = e.selection.getRng();
        return ((e, t, n) => Cx(t, e, n, _g, Eg, dk))(n, e, o).orThunk(() => (ck(e, n, o), M.none()));
    ...
    hk = (e, t) => {
      ...
      return ((e, t) => {
        ...
        if (((e, t, n) => (t ? ((e, t) => ex(e, t).breakAt.isNone())(e.dom, n) : ((e, t) => Zw(e, t).breakAt.isNone())(e.dom, n)))(n, t, o)) {
    ...
    yk = (e, t) => t.keyCode === e.keyCode && t.shiftKey === e.shiftKey && t.altKey === e.altKey && t.ctrlKey === e.ctrlKey && t.metaKey === e.metaKey,
    Ck =
      (e, ...t) =>
        () =>
          e.apply(null, t),
    wk = (e, t) => Q(((e, t) => ee(((e) => $(e, (e) => ({ ...vk, ...e })))(e), (e) => (yk(e, t) ? [e] : [])))(e, t), (e) => e.action()),
    xk = (e, t) => ce(((e, t) => ee(((e) => $(e, (e) => ({ ...vk, ...e })))(e), (e) => (yk(e, t) ? [e] : [])))(e, t), (e) => e.action()),
    kk = (e, t) => {
      const n = t ? hc.Forwards : hc.Backwards,
        o = e.selection.getRng();
    ...
    Ek = Ti([{ none: ['current'] }, { first: ['current'] }, { middle: ['current', 'target'] }, { last: ['current'] }]),
    Nk = { ...Ek, none: (e) => Ek.none(e) },
    Rk = (e, t, n) => ee(Nn(e), (e) => (pn(e, t) ? (n(e) ? [e] : []) : Rk(e, t, n))),
    Ak = (e, t) => Xo(e, 'table', t),
    Ok = (e, t, n, o, r = L) => {
      const s = 1 === o;
    ...
    Bk = (e, t = !1) => {
      return zn(e) ? e.dom.isContentEditable : ((n = e), Xo(n, '[contenteditable]')).fold(N(t), (e) => 'true' === Dk(e));
      var n;
    },
    ...
    Pk = (e, t, n, o, r) => {
      const s = vr(mn(n), 'td,th,caption').map((e) => e.dom),
        a = K(
          ((e, t) =>
            ee(t, (t) => {
              const n = ((e, t) => ({ left: e.left - t, top: e.top - t, right: e.right + -2, bottom: e.bottom + -2, width: e.width + t, height: e.height + t }))(Da(t.getBoundingClientRect()), -1);
              return [
    ...
    Ik = (e, t, n) => {
      const o = e(t, n);
      return ((e) => e.breakType === qw.Wrap && 0 === e.positions.length)(o) || (!Po(n.getNode()) && ((e) => e.breakType === qw.Br && 1 === e.positions.length)(o))
      ...
      if (!t && Fk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() => ie(n.getClientRects()).bind((n) => Qw(tx(e, ai.before(t)), n.left)))
      ...
      if (t && Uk(o, s)) {
        const o = ((e, t, n) =>
          ((e, t) =>
            ...
            .orThunk(() => ie(n.getClientRects()).bind((n) => Qw(nx(e, ai.after(t)), n.left)))
    ...
    Yk = (e, t) => {
      ...
      return ((e, t) => ((e, t, n = P) => (n(t) ? M.none() : j(e, Lt(t)) ? M.some(t) : Go(t, e.join(','), (e) => pn(e, 'table') || n(e))))(['td', 'th'], e, t))(mn(t ? s.endContainer : s.startContainer), r)
        .map(
          (n) => (
            Ak(n, r).each((t) => {
    ...
    Zk = (e, t, n) => {
      ...
      {
        const o = Ta(Qk);
        return M.from(o.backwards(e, t, Jk(e), n)).map((e) => Xk(e.container, e.container.data.length));
      }
    },
    eS = (e, t, n) => {
    ...
    tS = (e, t, n) => {
      ...
      {
        const r = Ta(Qk);
        return M.from(r.forwards(e, t, Jk(e), n)).bind((e) => tS(e.container, t - o.length, n));
      }
    },
    nS = (e, t, n, o, r) => {
      const s = Ta(
        ...
        (
          (e) => (t) =>
            e.isBlock(t) || j(['BR', 'IMG', 'HR', 'INPUT'], t.nodeName) || 'false' === e.getContentEditable(t)
        )(e)
      );
        ...
        () =>
          ((e, t, n, o = 0) => {
            ...
            return nS(
              ...
              const s = oS(r);
              return 0 !== s.lastIndexOf(n) || sS(s, n).length < o ? M.none() : M.some({ text: sS(s, n), range: r, trigger: n });
            });
          })(e, t, n, o),
        (t) => {
          const o = e.createRng();
    ...
    lS = (e, t) => {
      const n = e.childNodes;
      return n.length > 0 && t < n.length ? lS(n[t], 0) : n.length > 0 && ((e) => 1 === e.nodeType)(e) && n.length === t ? iS(n[n.length - 1]) : Xk(e, t);
    },
    dS = (e, t, n, o = {}) => {
      var r;
      const s = t(),
            ...
            t.matches.getOrThunk(() =>
              ((e) => (t) => {
                ...
                return !((e, t) => {
                  ...
                  return nS(e, t.container, t.offset, (e, t) => (0 === t ? -1 : t), o)
                    .filter((e) => {
      ...
      const l = Promise.all($(i, (e) => e.fetch(n.text, e.maxResults, o).then((t) => ({ matchText: n.text, items: t, columns: e.columns, onAction: e.onAction, highlightOn: e.highlightOn }))));
  ...
  const uS = (e, t, n) => (e.stype === cS.Error ? t(e.serror) : n(e.svalue)),
    ...
    gS = uS,
    pS = (e) => (f(e) && ue(e).length > 100 ? ' removed due to size' : JSON.stringify(e, null, 2)),
    hS = (e, t) => fS([{ path: e, getErrorInfo: t }]),
    bS = (e, t) => ({
      extract: (n, o) =>
        we(o, e).fold(
          () => ((e, t) => hS(e, () => 'Choice schema did not contain choice key: "' + t + '"'))(n, e),
          (e) =>
            ((e, t, n, o) =>
              we(n, o).fold(
                () => ((e, t, n) => hS(e, () => 'The chosen schema: "' + n + '" did not exist in branches: ' + pS(t)))(e, n, o),
    ...
    kS = (e) => ({
      extract: (t, n) => {
        return (o = e(n)), (r = (e) => ((e, t) => hS(e, N(t)))(t, e)), o.stype === cS.Error ? r(o.serror) : o;
        var o, r;
      },
      toString: N('val'),
    }),
        ...
        a = (e) =>
          e.fold(
            ...
            (e) => {
              ...
              return (s = n), (a = M.some), s.stype === cS.Value ? { stype: cS.Value, svalue: a(s.svalue) } : s;
              var s, a;
            }
          );
      switch (e.tag) {
        case 'required':
          return ((e, t, n, o) => we(t, n).fold(() => ((e, t, n) => hS(e, () => 'Could not find valid *required* value for "' + t + '" in ' + pS(n)))(e, n, t), o))(t, n, o, s);
        case 'defaultedThunk':
    ...
    AS = (e, t, n) => {
      return (o = ((e, t, n) => ((e, t) => (e.stype === cS.Error ? { stype: cS.Error, serror: t(e.serror) } : e))(t.extract([e], n), (e) => ({ input: n, errors: e })))(e, t, n)), uS(o, Oi.error, Oi.value);
      var o;
    },
    OS = (e, t) => bS(e, ge(t, NS)),
    TS = N(SS),
    ...
    LS = BS(b, 'boolean'),
    MS = BS(w, 'function'),
    IS = (e, t, n, o) => ({ tag: 'field', key: e, newKey: t, presence: n, prop: o }),
    ...
    WS = (e, t, n) =>
      VS(
        ...
        t,
        ((e) => {
          return (t = (t) => (j(e, t) ? Oi.value(t) : Oi.error(`Unsupported value: "${t}", choose one of "${e.join(', ')}".`))), kS((e) => t(e).fold(fS, mS));
          var t;
        })(n)
      ),
    KS = (e, t) => VS(e, t, LS),
    ...
    i_ = NS([YS, zS('trigger'), qS('minChars', 1), (1, ((e, t) => IS(e, e, CS(1), TS()))('columns')), qS('maxResults', 10), ('matches', HS('matches', MS)), XS, QS, ((l_ = PS), VS('highlightOn', [], RS(l_)))]);
  var l_;
  const d_ = [r_, t_, e_, ZS, JS],
    c_ = [o_].concat(d_),
    u_ = [GS('predicate', P), WS('scope', 'node', ['node', 'editor']), WS('position', 'selection', ['node', 'selection', 'line'])],
  ...
  NS([a_('contextform'), GS('initValue', N('')), n_, ((e, t) => IS(e, e, { tag: 'required', process: {} }, RS(t)))('commands', h_), HS('launch', OS('type', { contextformbutton: g_, contextformtogglebutton: p_ }))].concat(u_));
  const b_ = (e) => {
    const t = e.ui.registry.getAll().popups,
      n = ge(t, (e) => {
        return ((t = e), AS('Autocompleter', i_, { trigger: t.ch, ...t })).fold((e) => {
          throw new Error(
            'Errors: \n' +
            ((e) => {
      ...
      const t = ua(),
        ...
        a = (a) => {
          ((n) =>
            t
              .get()
              .map((t) => aS(e.dom, e.selection.getRng(), t.trigger).bind((t) => dS(e, s, t, n)))
              .getOrThunk(() =>
                ((e, t) => {
                  const n = t(),
                    o = e.selection.getRng();
                  return ((e, t, n) => ce(n.triggers, (n) => aS(e, t, n)))(e.dom, o, n).bind((n) => dS(e, t, n));
                })(e, s)
              ))(a).fold(r, (s) => {
                ((n) => {
                  o() ||
    ...
    x_ = (e, t) => {
      ...
      } else Po(t) ? (t.nextSibling && n.isBlock(t.nextSibling) ? (r.setStartBefore(t), r.setEndBefore(t)) : (r.setStartAfter(t), r.setEndAfter(t))) : (r.setStart(t, 0), r.setEnd(t, 0));
    ...
    S_ = (e) => M.from(e.dom.getParent(e.selection.getStart(!0), e.dom.isBlock)),
    __ = (e, t) => {
    ...
    B_ = (e, t) => C(t) && e.isBlock(t) && !/^(TD|TH|CAPTION|FORM)$/.test(t.nodeName) && !/^(fixed|absolute)/i.test(t.style.position) && 'true' !== e.getContentEditable(t),
    D_ = (e, t, n) => (Ro(t) ? (e ? (1 === n && t.data.charAt(n - 1) === _r ? 0 : n) : n === t.data.length - 1 && t.data.charAt(n) === _r ? t.data.length : n) : n),
    P_ = (e, t) => {
      ...
      insert: (e, t) => {
        ...
        const i = e.dom,
          ...
          f = (t) => {
            ...
            let d = a;
            if (!1 === ol(e)) i.setAttrib(a, 'style', null), i.setAttrib(a, 'class', null);
            else
              do {
                if (s[o.nodeName]) {
          ...
          g = (e) => {
            ...
            const r = new Zo(n, w);
            let s;
            for (Ro(n) && (e && 0 === t ? r.prev() : e || t !== n.data.length || r.next()); (s = r.current());) {
              if (yo(s)) {
          ...
          p = () => {
            let t;
            return (
              (t = /^(H[1-6]|PRE|FIGURE)$/.test(r) && 'HGROUP' !== x ? f(u) : f()),
              ((e, t) => {
                const n = rl(e);
        ...
        const h = !(!t || !t.shiftKey),
          b = !(!t || !t.ctrlKey);
        yo(n) && n.hasChildNodes() && ((a = o > n.childNodes.length - 1), (n = n.childNodes[Math.min(o, n.childNodes.length - 1)] || n), (o = a && Ro(n) ? n.data.length : 0));
        const v = k_(i, n);
        if (
          !v ||
          ((e, t) => {
        ...
        h ||
          (n = ((e, t, n, o, r) => {
            ...
            if (!l || !B_(a, l)) {
              let s;
              if (((l = l || i), (s = l === e.getBody() || Uo(l) ? l.nodeName.toLowerCase() : l.parentNode ? l.parentNode.nodeName.toLowerCase() : ''), !l.hasChildNodes())) {
                const o = a.create(t);
                return P_(e, o), l.appendChild(o), n.setStart(o, 0), n.setEnd(o, 0), o;
              }
              let d,
                c = o;
              ...
              if (d && e.schema.isValidChild(s, t.toLowerCase())) {
                const s = d.parentNode,
                  i = a.create(t);
                for (P_(e, i), s.insertBefore(i, d), c = d; c && !a.isBlock(c);) {
        ...
        if (('LI' !== x || b || ((w = s), (s = s.parentNode), (r = x)), /^(LI|DT|DD)$/.test(r) && yo(s) && i.isEmpty(w)))
          return void ((e, t, n, o, r) => {
            ...
            else if (R_(n, o, !0)) __(n, 'LI') ? (s.insertAfter(d, N_(n)), d.appendChild(s.doc.createTextNode(' ')), d.appendChild(n)) : i.insertBefore(d, n), s.remove(o);
        ...
        if (Or(w)) (S = Fr(w)), i.isEmpty(w) && O_(w), P_(e, S), x_(e, S);
        ...
        else if (g(!0) && k) (S = k.insertBefore(f(), w)), x_(e, T_(w, 'HR') ? S : w);
        else {
          const t = ((e) => {
            const t = e.cloneRange();
          ...
          ((e) => {
            ...
            ((e, t, n) => {
              ...
              let a = r.length;
              for (; a--;) (s = r[a]), (!s.hasChildNodes() || (s.firstChild === s.lastChild && '' === (null === (o = s.firstChild) || void 0 === o ? void 0 : o.nodeValue)) || A_(e, s)) && e.remove(s);
            })(i, d, S),
            ((e, t) => {
              t.normalize();
              const n = t.lastChild;
              (!n || (yo(n) && /^(left|right)$/gi.test(e.getStyle(n, 'float', !0)))) && e.add(t, 'br');
            })(i, w),
            i.isEmpty(w) && O_(w),
            S.normalize(),
    ...
    M_ = (e, t, n) => {
      ...
      n ? (o.setStartBefore(t), o.setEndBefore(t)) : (o.setStartAfter(t), o.setEndAfter(t)), e.selection.setRng(o), hf(e, o);
    },
    I_ = (e, t) => {
      const n = cn('br');
        ...
        n.isSome()
          ...
          : ((e, t) => {
            ...
            if (yo(l) && l.hasChildNodes()) {
              ...
              (l = l.childNodes[Math.min(i, l.childNodes.length - 1)] || l), (i = e && Ro(l) ? l.data.length : 0);
            }
            ...
            'LI' !== u || m || (d = c),
              ...
              (((e, t, n) => {
                ...
                for (; (r = o.next());) if (s[r.nodeName.toLowerCase()] || (Ro(r) && r.length > 0)) return !0;
                return !1;
    ...
    K_ = (e) => (t, n) =>
      ((e) =>
        S_(e)
          ...
          .isSome())(t) === e,
    G_ = (e, t) => (n, o) => {
      const r = ((e) => S_(e).fold(N(''), (e) => e.nodeName.toUpperCase()))(n) === e.toUpperCase();
      return r === t;
    },
    Y_ = (e) => {
    ...
    tE = (e, t) => (n, o) => Y(e, (e, t) => e && t(n, o), !0) ? M.some(t) : M.none(),
    nE = (e, t, n) => {
      t.selection.isCollapsed() ||
        ((e) => {
          e.execCommand('delete');
        })(t),
        (C(n) && w_(t, e.fakeEventName).isDefaultPrevented()) || (e.insert(t, n), C(n) && C_(t, e.fakeEventName));
    },
    oE = (e, t) => {
      const n = () => nE($_, e, t),
        o = () => nE(L_, e, t),
    ...
    iE = (e, t, n) => {
      n && !e.get() ? t.on('NodeChange', sE, !0) : !n && e.get() && t.off('NodeChange', sE), e.set(n);
    },
    lE = (e, t) => {
      const n = t.container(),
        o = t.offset();
    ...
    cE = O(lE, ' '),
    uE = (e, t) => (n) =>
      ((e, t) => !Kg(t) && (((e, t) => ((e, t) => Mc(e.dom, t).isNone())(e, t) || ((e, t) => Lc(e.dom, t).isNone())(e, t) || Dg(e, t) || Pg(e, t) || zg(e, t) || Ug(e, t))(e, t) || qg(e, t) || Wg(e, t)))(e, n) ? dE(t) : cE(t),
    mE = (e) => {
      ...
      if (e.selection.isCollapsed()) {
        ...
        return Mw(o, e.getBody(), r)
          ...
          .map((o) => () => uE(n, t)(o).each(((e) => (t) => (e.selection.setRng(t.toRange()), e.nodeChanged(), !0))(e)));
      }
      return M.none();
    },
    fE = (e) =>
      Ed(e)
        ...
        : [],
    gE = (e) => {
      if ((e.addShortcut('Meta+P', '', 'mcePrint'), v_(e), By(e))) return ra(null);
      {
        const t = Ox(e);
        return (
          ((e) => {
                ...
                ((e, t, n) => {
                  ...
                  wk(
                    [
                      ...
                      ...(o
                        ? [
                          { keyCode: bm.UP, action: Ck(gk, e, !1), metaKey: !0, shiftKey: !0 },
                          { keyCode: bm.DOWN, action: Ck(gk, e, !0), metaKey: !0, shiftKey: !0 },
                        ]
                        : []),
                      ...
                      { keyCode: bm.RIGHT, ctrlKey: !o, altKey: o, action: Ck(Tx, e, t) },
                      { keyCode: bm.LEFT, ctrlKey: !o, altKey: o, action: Ck(Bx, e, t) },
          ...
          ((e, t) => {
            e.on('keydown', (n) => {
              n.isDefaultPrevented() ||
                ((e, t, n) => {
                  const o = n.keyCode === bm.BACKSPACE ? 'deleteContentBackward' : 'deleteContentForward';
                  xk(
                    [
                    ...
                    n.preventDefault(), w_(e, o).isDefaultPrevented() || (t(), C_(e, o));
                  });
                })(e, t, n);
            }),
              e.on('keyup', (t) => {
          ...
          ((e) => {
            e.on('keydown', (t) => {
              t.isDefaultPrevented() ||
                ((e, t) => {
                  xk([{ keyCode: bm.SPACEBAR, action: Ck(mE, e) }], t).each((n) => {
                    t.preventDefault(), w_(e, 'insertText', { data: ' ' }).isDefaultPrevented() || (n(), C_(e, 'insertText', { data: ' ' }));
                  });
                })(e, t);
            });
          })(e),
                  ...
                  wk(
                    [
                      ...
                      ...(o
                        ? []
                        : [
                          { keyCode: bm.HOME, action: Ck(gk, e, !1), ctrlKey: !0, shiftKey: !0 },
                          { keyCode: bm.END, action: Ck(gk, e, !0), ctrlKey: !0, shiftKey: !0 },
                        ]),
  ...
  class pE {
    constructor(e) {
      ...
      'onselectionchange' in e.getDoc() ||
        e.on('NodeChange click mouseup keyup focus', (n) => {
          ...
          ('nodechange' !== n.type && Um(r, t)) || e.dispatch('SelectionChange'), (t = r);
        }),
        e.on('contextmenu', () => {
        ...
        e.on('SelectionChange', () => {
          ...
          t && vu(e) && !n.isSameElementPath(t) && e.dom.isChildOf(t, e.getBody()) && e.nodeChanged({ selectionChange: !0 });
        }),
        e.on('mouseup', (t) => {
          !t.isDefaultPrevented() &&
            vu(e) &&
    ...
    nodeChanged(e = {}) {
      ...
      let n;
      if (this.editor.initialized && t && !Wl(this.editor) && !this.editor.mode.isReadOnly()) {
  ...
  const hE = N('x-tinymce/html'),
    ...
    OE = (e, t, n) =>
      !!((e, t) => RE(t) && H(_d(e), (e) => je(t.toLowerCase(), `.${e.toLowerCase()}`)))(e, t) &&
      ((e, t, n) => (
        e.undoManager.extra(
          () => {
            n(e, t);
    ...
    FE = (e, t, n) => {
      ...
      if (dd(e) && o) {
        ...
        if (s.length > 0)
          return (
            t.preventDefault(),
            ((r = s), Promise.all($(r, (e) => Pv(e).then((t) => ({ file: e, uri: t }))))).then((t) => {
    ...
    zE = (e, t, n) => {
      ((e, t, n) => {
        let o;
        e.on('keydown', (e) => {
          ((e) => (bm.metaKeyPressed(e) && 86 === e.keyCode) || (e.shiftKey && 45 === e.keyCode))(e) && !e.isDefaultPrevented() && (o = e.shiftKey && 86 === e.keyCode);
        }),
          e.on('paste', (r) => {
            if (
        ...
        ((e) => {
          ...
          e.parser.addNodeFilter('img', (o, r, s) => {
            if (
              ...
              for (const r of o) {
                const o = r.attr('src');
                m(o) && !r.attr('data-mce-object') && o !== Nt.transparentSrc && (t(o) || (!vd(e) && n(o))) && r.remove();
              }
          });
        })(e);
    },
    jE = (e, t, n, o) => {
      ((e, t, n) => {
        if (!e) return !1;
        try {
          return e.clearData(), e.setData('text/html', t), e.setData('text/plain', n), e.setData(hE(), t), !0;
        } catch (e) {
          return !1;
        }
    ...
    $E = (e) => ({ html: vE(e.selection.getContent({ contextual: !0 })), text: e.selection.getContent({ format: 'text' }) }),
    VE = (e) => !e.selection.isCollapsed() || ((e) => !!e.dom.getParent(e.selection.getStart(), 'td[data-mce-selected],th[data-mce-selected]', e.getBody()))(e),
    qE = (e, t) => {
      var n, o;
      return Ym.getCaretRangeFromPoint(null !== (n = t.clientX) && void 0 !== n ? n : 0, null !== (o = t.clientY) && void 0 !== o ? o : 0, e.getDoc());
    },
    WE = (e, t) => {
      ...
      if (r && 'none' !== o) {
        ...
        t = t.replace(/(<[^>]+) style="([^"]*)"([^>]*>)/gi, (e, t, s, a) => {
          ...
          for (let e = 0; e < r.length; e++) {
            ...
            /color/.test(r[e]) && ((s = GE(s)), (a = GE(a))), a !== s && (l[r[e]] = t);
          }
      ...
      ((e) => {
        ...
        ((e, t) => {
          e.addCommand('mceTogglePlainTextPaste', () => {
            ((e, t) => {
              'text' === t.get() ? (t.set('html'), hm(e, !1)) : (t.set('text'), hm(e, !0)), e.focus();
            })(e, t);
          }),
            ...
            ((e, t) => {
              ld(e) &&
                ...
                e.on('dragover dragend', (n) => {
                  dd(e) && !t.get() && (n.preventDefault(), WE(e, qE(e, n))), 'dragend' === n.type && t.set(!1);
                });
            })(e, t),
            zE(e, o, n);
        });
    ...
    oN = (e) => {
      const t = ((e, t) => {
        const n = ai.fromRangeStart(e).getNode(),
          o = ((e, t) => Ko(mn(e), (e) => ((e) => Mo(e.dom))(e) || nr(e), eN(t)).getOr(mn(t)).dom)(n, t),
          r = nN(n, o, !1),
          s = nN(n, o, !0),
  ...
  const sN = (e, t) => Math.abs(e.left - t),
    ...
    lN = (e, t, n) => (t > e.left && t < e.right ? 0 : Math.min(Math.abs(e.left - t), Math.abs(e.right - t))),
    dN = (e, t, n) => {
      const o = (e) => (Gr(e.node) ? M.some(e) : yo(e.node) ? dN(de(e.node.childNodes), t, n) : M.none()),
        r = (e, r) => {
    ...
    cN = (e, t, n) =>
      ((e, t, n) => {
        ...
        .filter((e) => Hd(e.node))
        .map((e) => ((e, t) => ({ node: e.node, position: sN(e, t) < aN(e, t) ? rN.Before : rN.After }))(e, t)),
    uN = (e) => {
      var t, n;
    ...
    wN = (e, t) => {
      ...
      return (r) =>
        e.on((e) => {
          ...
          if (e.dragging) {
            const s = ((e, t) => ({ pageX: t.pageX - e.relX, pageY: t.pageY + 5 }))(
              e,
              ((e, t) => {
                return (
                  (n = ((e) => (e.inline ? uN(e.getBody()) : { left: 0, top: 0 }))(e)),
                  (o = ((e) => {
                    const t = e.getBody();
            ...
            (a = e.ghost),
              ...
              ((e, t, n, o, r, s, a, i, l, d, c) => {
                let u = 0,
                  m = 0;
                (e.style.left = t.pageX + 'px'), (e.style.top = t.pageY + 'px'), t.pageX + n > r && (u = t.pageX + n - r), t.pageY + o > s && (m = t.pageY + o - s), (e.style.width = n - u + 'px'), (e.style.height = o - m + 'px');
              ...
              })(e.ghost, s, e.width, e.height, e.maxX, e.maxY, r.clientY, r.clientX, t.getContentAreaContainer(), t.getWin(), o),
        ...
        a = ((e, t) => (n) => {
          e.on((e) => {
            if ((e.intervalId.clear(), e.dragging)) {
              if (
                ((e, t, n) => !y(t) && t !== n && !e.dom.isChildOf(t, n) && !mN(t))(
                  t,
                  ((e) => {
                    const t = e.getSel();
                    if (C(t)) {
                ...
                t.dispatch('drop', { clientX: n.clientX, clientY: n.clientY }).isDefaultPrevented() ||
                  t.undoManager.transact(() => {
                    CN(e.element), t.insertContent(t.dom.getOuterHTML(o)), t._selectionOverrides.hideFakeCaret();
                  });
              }
              t.dispatch('dragend');
            }
      ...
      const l = (e) => e !== o && (SN(e) || zo(e)) && n.isChildOf(e, o),
        ...
        f = (r, c) => {
          ...
          let m = r.startContainer,
            f = r.startOffset;
          const g = r.endOffset;
          if ((Ro(m) && 0 === f && SN(m.parentNode) && ((m = m.parentNode), (f = n.nodeIndex(m)), (m = m.parentNode)), !yo(m))) return null;
              ...
              return ((o) => {
                ...
                const d = ((o, r) => {
                  const a = mn(e.getBody()),
                    ...
                    d = n.createRng();
                  eo(l), Zn(l, [un(pr, i), mn(r), un(pr, i)]), d.setStart(l.dom.firstChild, 1), d.setEnd(l.dom.lastChild, 0), $n(l, { top: n.getPos(o, e.getBody()).y + 'px' }), bf(l);
                  const c = t.getSel();
        ...
        g = () => {
          i && i.removeAttribute(a), Yo(mn(e.getBody()), '#' + s).each(to), (i = null);
        },
        p = () => {
          r.hide();
        };
        ...
        (e.on('click', (t) => {
          ...
          e.on(
            ...
            (t) => {
              const n = t.target,
                o = _N(e, n);
              SN(o) ? (t.preventDefault(), tw(e, o).each(f)) : l(n) && tw(e, n).each(f);
            },
            !0
          ),
          e.on('mousedown', (r) => {
              ...
              !((e, t, n) => {
                const o = mn(e.getBody()),
                  ...
                  s = ((e, t, n, o) => {
                    ...
                    return { x: n - (e ? r.left + t.dom.clientLeft + rC(t) : 0), y: o - (e ? r.top + t.dom.clientTop + oC(t) : 0) };
                  })(e.inline, r, t, n);
                return ((e, t, n) => {
                  const o = tC(e),
                    r = nC(e);
            ...
            SN(a)
              ...
              : cN(o, r.clientX, r.clientY).each((n) => {
                var o;
                r.preventDefault(), (o = d(1, n.node, n.position === rN.Before, !1)) && t.setRng(o), yo(a) ? a.focus() : e.getBody().focus();
              });
          }),
          e.on('keypress', (e) => {
          ...
          e.on('AfterSetSelectionRange', (e) => {
            ...
            var r;
            u(t) || (yo((r = o)) && 'mcepastebin' === r.id) || p(), ((e) => C(e) && n.hasClass(e, 'mce-offscreen-selection'))(o) || g();
          }),
          ((e) => {
            kN(e),
              Ql(e) &&
              ((e) => {
                const t = (t) => {
                  if (!t.isDefaultPrevented()) {
                    ...
                    n && (j(n.types, 'Files') || n.files.length > 0) && (t.preventDefault(), 'drop' === t.type && cC(e, 'Dropped file type is not supported'));
                  }
                },
                  n = (n) => {
                    Bf(e, n.target) && t(n);
              ...
              e.on('focusin', (t) => {
                ...
                if (zo(n)) {
                  const t = Zp(e.getBody(), n),
                    o = Io(t) ? t : n;
                  e.selection.getNode() !== o && tw(e, o).each((t) => e.selection.setRng(t));
                }
              });
            });
          })(e)),
    ...
    NN = (e, t) => {
      let n = t;
      for (let t = e.previousSibling; Ro(t); t = t.previousSibling) n += t.data.length;
      return n;
    },
    RN = (e, t, n, o, r) => {
    ...
    AN = (e, t, n, o, r, s, a = !1) => ({ start: RN(e, t, n, o, a), end: RN(e, t, r, s, a) }),
    ON = (e, t) => {
      const n = t.slice(),
        o = n.pop();
      return x(o) ? Y(n, (e, t) => e.bind((e) => M.from(e.childNodes[t])), M.some(e)).bind((e) => (Ro(e) && (o < 0 || o > e.data.length) ? M.none() : M.some({ node: e, offset: o }))) : M.none();
    },
    TN = (e, t) =>
    ...
    DN = (e, t, n, o = !0) => {
      ...
      t.deleteContents(),
        o &&
        !n(t.startContainer) &&
        (Ro(t.startContainer) && 0 === t.startContainer.data.length && e.remove(t.startContainer), Ro(t.endContainer) && 0 === t.endContainer.data.length && e.remove(t.endContainer), BN(e, r, n), r !== s && BN(e, s, n));
    },
    PN = (e, t) => M.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
    LN = (e, t, n) => {
      const o = e.dynamicPatternsLookup({ text: n, block: t });
      return { ...e, blockPatterns: Li(o).concat(e.blockPatterns), inlinePatterns: Mi(o).concat(e.inlinePatterns) };
    },
    MN = (e, t, n, o) => {
      const r = e.createRng();
    ...
    IN = (e, t, n) => {
      ((e, t, n) => {
        ...
        {
          const t = Ta(Qk);
          return M.from(t.forwards(e, 0, Jk(e), n)).map((e) => Xk(e.container, 0));
        }
      })(t, 0, t).each((o) => {
        const r = o.container;
        tS(r, n.start.length, t).each((n) => {
          const o = e.createRng();
          o.setStart(r, 0), o.setEnd(n.container, n.offset), DN(e, o, (e) => e === t);
        });
      });
    },
    ...
    zN = (e, t, n) => {
      const o = TN(e.getRoot(), n).getOrDie('Unable to resolve path range'),
        ...
        l = i.parentNode;
      return { prefix: t, end: a.parentNode.insertBefore(FN(e, t + '-end'), a), start: l.insertBefore(FN(e, t + '-start'), i) };
    },
    jN = (e, t, n) => {
    ...
    VN = (e, t, n, o) => {
      ...
      return eS(i, l - n.pattern.end.length, t).bind((d) => {
        ...
        if (HN(a)) return M.some({ matches: [{ pattern: a, startRng: c, endRng: c }], position: d });
        {
          ...
          return m.map((e) => {
            const t = ((e, t, n, o = !1) => AN(e, t, n.startContainer, n.startOffset, n.endContainer, n.endOffset, o))(r, s, e, o);
            return { matches: l.matches.concat([{ pattern: a, startRng: t, endRng: c }]), position: Xk(e.startContainer, e.startOffset) };
          });
        }
      });
    },
    qN = (e, t, n, o, r, s) => {
      ...
      return Zk(n, o, a.getRoot()).bind((i) => {
        ...
        for (let n = 0; n < t.length; n++) {
          ...
          const a = t.slice();
          a.splice(n, 1);
          const d = VN(e, r, { pattern: o, remainingPatterns: a, position: i }, s);
          ...
          return G(
            ...
            (t, r) => {
              const s = o.length - t.length - 1,
                a = HN(r.pattern) ? r.endMarker : zN(e, n + `_start${s}`, r.startRng);
        ...
        .map((o) => {
          ...
          const s = Math.max(0, n.startOffset),
            ...
            l = ((e, t, n, o) => {
              ...
              return ((e, t) => {
                const n = ((e) => se(e, (e, t) => t.start.length - e.start.length))(e),
                  o = t.replace(pr, ' ');
                return Q(n, (e) => 0 === t.indexOf(e.start) || 0 === o.indexOf(e.start));
              })(n.blockPatterns, i)
                .map((e) => (Tt.trim(i).length === e.start.length ? [] : [{ pattern: e, range: AN(s, s.getRoot(), t, 0, t, 0, true) }]))
                .getOr([]);
            })(e, o, a);
          return (
              ...
              e.undoManager.extra(
                ...
                () => {
                    ...
                    ((e, t) => {
                      ...
                      V(t, (t) =>
                        ((e, t) => {
                          const n = e.dom,
                            o = t.pattern,
                            r = TN(n.getRoot(), t.range).getOrDie('Unable to resolve path range');
                          return (
                            PN(e, r).each((t) => {
                              'block-format' === o.type
                                ? ((e, t) => {
                                ...
                                e.undoManager.transact(() => {
                                  IN(e.dom, t, o), e.execCommand(o.cmd, !1, o.value);
                                });
                            }),
                            !0
                          );
                  ...
                  e.execCommand('mceInsertNewLine'),
                    n.each((t) => {
                      const n = t.container;
                      n.data.charAt(t.offset - 1) === gr && (n.deleteData(t.offset - 1, 1), BN(e.dom, n.parentNode, (t) => t === e.dom.getRoot()));
                    });
                }
              ),
              !0)
    ...
    QN = (e) => {
      const t = Tt.each,
        ...
        y = () => {
          Kl(e) ||
            e.on('BeforeExecCommand mousedown', () => {
              m('StyleWithCSS', !1), m('enableInlineTableEditing', !1), _l(e) || m('enableObjectResizing', !1);
            });
        },
        C = () => {
        ...
        k = () => {
          u &&
            e.on('keydown', (t) => {
              !bm.metaKeyPressed(t) || t.shiftKey || (37 !== t.keyCode && 39 !== t.keyCode) || (t.preventDefault(), e.selection.getSel().modify('move', 37 === t.keyCode ? 'backward' : 'forward', 'lineboundary'));
            });
        },
        _ = () => {
          e.on('click', (e) => {
    ...
    sR = (e) => {
      !0 !== e.removed &&
        (((e) => {
          By(e) || e.load({ initial: !0, format: 'html' }), (e.startContent = e.getContent({ format: 'raw' }));
        })(e),
          ((e) => {
    ...
    aR = (e) => {
      ...
      let n = e.getDoc();
      e.inline && (JN.addClass(t, 'mce-content-body'), (e.contentDocument = n = document), (e.contentWindow = window), (e.bodyElement = t), (e.contentAreaContainer = t));
      const o = e.getBody();
      (o.disabled = !0),
        (e.readonly = Kl(e)),
        e.readonly || (e.inline && 'static' === JN.getStyle(o, 'position', !0) && (o.style.position = 'relative'), (o.contentEditable = 'true')),
        (o.disabled = !1),
        (e.editorUpload = xC(e)),
        (e.schema = Ls(nR(e))),
        (e.dom = ta(n, {
        ...
        (e.parser = ((e) => {
          ...
          return (
            ...
            t.addNodeFilter('p,h1,h2,h3,h4,h5,h6,div', (t) => {
              ...
              for (; n--;) {
                const e = t[n];
                e.isEmpty(o) && 0 === e.getAll('br').length && e.append(new Zf('br', 1));
              }
            }),
            t
          );
          ...
          ((e) => {
            ((e) => {
              const t = [',', '.', ';', ':', '!', '?'],
                n = [32],
                o = () => {
                  return (t = yd(e)), (n = Cd(e)), { inlinePatterns: Mi(t), blockPatterns: Li(t), dynamicPatternsLookup: n };
                  var t, n;
                },
              ...
              e.on(
                'keydown',
                (t) => {
                  if (13 === t.keyCode && !bm.modifierPressed(t) && e.selection.isCollapsed()) {
                    const n = o();
                    (n.inlinePatterns.length > 0 || n.blockPatterns.length > 0 || r()) && YN(e, n) && t.preventDefault();
                  }
                },
                !0
              );
              ...
              e.on('keyup', (e) => {
                XN(n, e, (e, t) => e === t.keyCode && !bm.modifierPressed(t)) && s();
              }),
                e.on('keypress', (n) => {
                  XN(t, n, (e, t) => e.charCodeAt(0) === t.charCode) && Af.setEditorTimeout(e, s);
                });
            })(e);
          })(e));
      const r = gE(e);
      Qx(e, r),
        ...
        ((e) => {
            ...
            s = (t, a) => {
              if (
                ((e) => {
                  if (FC(e)) {
                    const t = e.keyCode;
                    return !UC(e) && (bm.metaKeyPressed(e) || e.altKey || (t >= 112 && t <= 123) || j(MC, t));
                  }
                  return !1;
                })(t)
              )
              ...
              const i = e.getBody(),
                l =
                  !((e) => FC(e) && !(UC(e) || ('keyup' === e.type && 229 === e.keyCode)))(t) &&
                  ((e, t, n) => {
                    if (ss(mn(t), !1)) {
          ...
          We(r) &&
            e.on('init', (t) => {
              s(t, !0), e.on('change SetContent ExecCommand', s), e.on('paste', (t) => Af.setEditorTimeout(e, () => s(t)));
            });
        })(e),
        XE(e);
      const s = ((e) => {
      ...
      ((e) => {
        ...
        ((e) => {
          ...
          ad(e) || ((t.body.spellcheck = !1), JN.setAttrib(n, 'spellcheck', 'false')),
          (e.quirks = QN(e)),
          ((e) => {
            ...
            e.setProgressState(!0),
              rR(e).then(() => {
                t().then(
                  ...
                  (t) => {
                    e.notificationManager.open({ type: 'error', text: String(t) }), sR(e), Ly(e);
                  }
                );
              });
          }
    ...
    iR = (e, t) => {
      if ((e.inline || (e.getElement().style.visibility = e.orgVisibility), t || e.inline)) aR(e);
      else {
    ...
    mR = (e) => {
      e.dispatch('ScriptsLoaded'),
        ...
        ((e) => {
          ...
          if (m(t)) {
            const n = iC.get(t);
            (e.theme = n(e, iC.urls[t]) || {}), w(e.theme.init) && e.theme.init(e, iC.urls[t] || e.documentBaseUrl.replace(/\/$/, ''));
          } else e.theme = {};
        })(e),
        ((e) => {
          const t = Bl(e),
            ...
            ((e, t, n) => {
              ...
              if (((n = Tt.trim(n)), o && -1 === Tt.inArray(t, n))) {
                ...
                try {
                  ...
                  ((e, t, n) => {
                    const o = la.translate(['Failed to initialize plugin: {0}', t]);
      ...
      ((e, t) => {
        ...
        ((e) => {
          e.contentCSS = e.contentCSS.concat(((e) => gC(e, Cl(e)))(e), ((e) => gC(e, xl(e)))(e));
        })(e),
        e.inline
          ? iR(e)
          : ((e, t) => {
            ((e, t) => {
              const n = e.translate('Rich Text Area'),
                ...
                r = ((e, t, n, o) => {
                  const r = cn('iframe');
                  return o.each((e) => Vt(r, 'tabindex', e)), qt(r, n), qt(r, { id: e + '_ifr', frameBorder: '0', allowTransparency: 'true', title: t }), nn(r, 'tox-edit-area__iframe'), r;
                })(e.id, n, qi(e), o).dom;
              (r.onload = () => {
                ...
                (e.iframeHTML = ((e) => {
                  ...
                  Ki(e) !== e.documentBaseUrl && (t += '<base href="' + e.documentBaseURI.getURI() + '" />'), (t += '<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />');
                  const n = Gi(e),
                    o = Yi(e),
                    r = e.translate(td(e));
                  return Xi(e) && (t += '<meta http-equiv="Content-Security-Policy" content="' + Xi(e) + '" />'), (t += `</head><body id="${n}" class="mce-content-body ${o}" data-id="${e.id}" aria-label="${r}"><br></body></html>`), t;
                })(e)),
                lR.add(t.iframeContainer, r);
            })(e, t),
              t.editorContainer && ((t.editorContainer.style.display = e.orgDisplay), (e.hidden = lR.isHidden(t.editorContainer))),
      ...
      ((e, t) => {
        ...
        ((e, t, n) => {
          const o = pR(t, 'default', n),
            r = ((e) =>
              M.from(dl(e))
                .filter(We)
                .map((e) => ({ url: e, name: M.none() })))(t).orThunk(() => pR(t, ll(t), ''));
          V(
            ((e) => {
              const t = [],
                n = (e) => {
        ...
        ((e, t) => {
          ...
          fe(Xl(e), (t, o) => {
            ...
            V(Yl(e), (e) => {
              !(e = Tt.trim(e)) || aC.urls[e] || gR(e) || n(e, `plugins/${e}/plugin${t}.js`);
            });
        })(e, t),
    ...
    kR = (e, t) => ({ table_grid: !1, object_resizing: !1, resize: !1, toolbar_mode: we(e, 'toolbar_mode').getOr('scrolling'), toolbar_sticky: !1, ...(t ? { menubar: !1 } : {}) }),
    SR = (e, t) => {
      var n;
    ...
    _R = (e, t, n, o, r) => {
      var s;
      const a = e ? { mobile: kR(null !== (s = r.mobile) && void 0 !== s ? s : {}, t) } : {},
        i = wR(['mobile'], yS(a, r)),
        l = Tt.extend(
          n,
          o,
      ...
      return ((e, t, n, o) => {
        const r = CR(n.forced_plugins),
          ...
          i = ((e, t, n, o) => (e && xR(t, 'mobile') ? o : n))(e, t, s, a.plugins ? CR(a.plugins) : s),
          l = ((e, t) => [...CR(e), ...CR(t)])(r, i);
    ...
    NR = (e, t) => {
      ...
      return /^ | $/.test(t)
        ? ((e, t, n) => {
          ...
          return (n = Yg(o, ai.fromRangeStart(t)) ? n.replace(/^ /, '&nbsp;') : n.replace(/^&nbsp;/, ' ')), Xg(o, ai.fromRangeEnd(t)) ? n.replace(/(&nbsp;| )(<br( \/)>)?$/, '&nbsp;') : n.replace(/&nbsp;(<br( \/)?>)?$/, ' ');
        })(o, n.getRng(), t)
        : t;
    },
    RR = (e, t) => {
      ...
      oy(e, { ...o, content: NR(e, n), format: 'html', set: !1, selection: !0 }).each((t) => {
      ...
      M.from(n)
        ...
        .bind((n) =>
          ((e, t, n) =>
            Sh(
              mn(n),
              (t) => ((t) => Wn(t, e).orThunk(() => (OR(t) ? we(AR, e).bind((e) => Kt(t, e)) : M.none())))(t),
              (e) => bn(mn(t), e)
            ))(e, t, n.dom).or(((e, t) => M.from(ta.DOM.getStyle(t, e, !0)))(e, n.dom))
        )
        .getOr(''),
    BR = TR('font-size'),
    DR = _((e) => e.replace(/[\'\"\\]/g, '').replace(/,\s+/g, ','), TR('font-family')),
    PR = (e) =>
      Ic(e.getBody()).bind((e) => {
        const t = e.container();
        ...
        ((e) => {
          e.editorCommands.addCommands({
            mceSelectNodeDepth: (t, n, o) => {
              let r = 0;
              e.dom.getParent(e.selection.getNode(), (t) => !yo(t) || r++ !== o || (e.selection.select(t), !1), e.getBody());
            },
            mceSelectNode: (t, n, o) => {
          ...
          ((e) => {
            ...
            e.editorCommands.addCommands({
              ...
              FontName: (t, n, o) => {
                ((e, t) => {
                  const n = MR(e, t);
                  e.formatter.toggle('fontname', { value: IR(n) }), e.nodeChanged();
                })(e, o);
              },
              FontSize: (t, n, o) => {
                ((e, t) => {
                  e.formatter.toggle('fontsize', { value: MR(e, t) }), e.nodeChanged();
                })(e, o);
              },
              LineHeight: (t, n, o) => {
                ((e, t) => {
            ...
            ((e) => {
              ...
              e.editorCommands.addCommands({ 'Bold,Italic,Underline,Strikethrough,Superscript,Subscript': (e) => t(e), mceBlockQuote: () => t('blockquote') }, 'state'),
                e.editorCommands.addQueryValueHandler('FontName', () => ((e) => LR(e, (t) => DR(e.getBody(), t.dom)).getOr(''))(e)),
                e.editorCommands.addQueryValueHandler('FontSize', () => ((e) => LR(e, (t) => BR(e.getBody(), t.dom)).getOr(''))(e)),
                ...
                e.removed ||
                  (t
                    ...
                    : ((e) => {
                      ...
                      if (r && e.dom.isChildOf(r, n)) return Mf(r), Lf(e, o), void Ff(e);
                      e.inline || (Nt.browser.isOpera() || Mf(n), e.getWin().focus()), (Nt.browser.isFirefox() || e.inline) && (Mf(n), Lf(e, o)), Ff(e);
                    })(e));
              })(e, !0 === o);
            },
            mceToggleVisualAid: () => {
  ...
  const zR = 'data-mce-contenteditable',
    ...
    qR = (e) => {
      e.parser.addAttributeFilter('contenteditable', (t) => {
        VR(e) &&
          V(t, (e) => {
            e.attr(zR, e.attr('contenteditable')), e.attr('contenteditable', 'false');
          });
      }),
  ...
  const YR = (e) => (
    ...
    XR = {
      ...
      dispatch(e, t, n) {
        const o = this;
        if (o.removed && 'remove' !== e && 'detach' !== e) return Us(e.toLowerCase(), null != t ? t : {}, o);
  ...
  const ZR = (e, t) => {
    ...
    const n = Rl(e);
    return n ? (e.eventRoot || (e.eventRoot = QR.select(n)[0]), e.eventRoot) : e.getBody();
  },
    eA = (e, t, n) => {
      ((e) => !e.hidden && !VR(e))(e)
        ? e.dispatch(t, n)
        ...
        ((e, t) => {
          if (((e) => 'click' === e.type)(t) && !bm.metaKeyPressed(t)) {
            const n = mn(t.target);
            ((e, t) => Xo(t, 'a', (t) => bn(t, mn(e.getBody()))).bind((e) => Kt(e, 'href')))(e, n).each((n) => {
    ...
    nA = {
      ...
      toggleNativeEvent(e, t) {
        ...
        'focus' !== e &&
          'blur' !== e &&
          (n.removed ||
            (t ? (n.initialized ? tA(n, e) : n._pendingNativeEvents ? n._pendingNativeEvents.push(e) : (n._pendingNativeEvents = [e])) : n.initialized && n.delegates && (n.dom.unbind(ZR(n, e), e, n.delegates[e]), delete n.delegates[e])));
      },
    ...
    oA = (e) => (m(e) ? { value: e.split(/[ ,]/), valid: !0 } : k(e, m) ? { value: e, valid: !0 } : { valid: !1, message: 'The value must be a string[] or a comma/space separated string.' }),
    ...
    dA = Tt.each,
    cA = Tt.explode,
    uA = { f1: 112, f2: 113, f3: 114, f4: 115, f5: 116, f6: 117, f7: 118, f8: 119, f9: 120, f10: 121, f11: 122, f12: 123 },
    mA = Tt.makeMap('alt,ctrl,shift,meta,access'),
    fA = (e) => {
      const t = {},
        n = Nt.os.isMacOS() || Nt.os.isiOS();
      dA(cA(e.toLowerCase(), '+'), (e) => {
        ((e) => e in mA)(e) ? (t[e] = !0) : /^[0-9]{2,}$/.test(e) ? (t.keyCode = parseInt(e, 10)) : ((t.charCode = e.charCodeAt(0)), (t.keyCode = uA[e] || e.toUpperCase().charCodeAt(0)));
      });
      const o = [t.keyCode];
      let r;
  ...
  class gA {
    ...
    createShortcut(e, t, n, o) {
      ...
      return (r[r.length - 1] = Tt.extend(r[r.length - 1], { func: n, scope: o || this.editor })), Tt.extend(r[0], { desc: this.editor.translate(t), subpatterns: r.slice(1) });
    }
    hasModifier(e) {
  ...
  class yA {
    constructor(e, t, n) {
      ...
      (this.options = ((e, t) => {
        const n = {},
          ...
          r = (e, t, n) => {
            const r = aA(t, n);
            return sA(r) ? ((o[e] = r.value), !0) : (console.warn(rA(`Invalid value passed for the ${e} option`, r)), !1);
          },
          s = (e) => xe(n, e);
        return {
          register: (e, s) => {
            const a = ((e) => m(e.processor))(s)
              ...
              i = ((e, t, n) => {
                if (!v(t)) {
                  ...
                  console.error(rA(`Invalid default value passed for the "${e}" option`, o));
                }
              })(e, s.default, a);
        ...
        ((e) => {
          ...
          t('id', { processor: 'string', default: e.id }),
            ...
            t('font_css', {
              processor: (e) => {
                const t = m(e) || k(e, m);
                return t ? { value: p(e) ? e : $(e.split(','), $e), valid: t } : { valid: !1, message: 'Must be a string or an array of strings.' };
              },
              default: [],
            }),
            ...
            t('object_resizing', {
              processor: (e) => {
                const t = b(e) || m(e);
                return t ? (!1 === e || Fi.isiPhone() || Fi.isiPad() ? { value: '', valid: t } : { value: !0 === e ? 'table,img,figure.image,div,video,iframe' : e, valid: t }) : { valid: !1, message: 'Must be boolean or a string' };
              },
              default: !Ui,
            }),
            ...
            t('text_patterns', {
              processor: (e) => (k(e, f) || !1 === e ? { value: Ii(!1 === e ? [] : e), valid: !0 } : { valid: !1, message: 'Must be an array of objects or false.' }),
              default: [
            ...
            t('noneditable_regexp', { processor: (e) => (k(e, ji) ? { value: e, valid: !0 } : ji(e) ? { value: [e], valid: !0 } : { valid: !1, message: 'Must be a RegExp or an array of RegExp.' }), default: [] }),
            t('table_tab_navigation', { processor: 'boolean', default: !0 }),
            e.on('ScriptsLoaded', () => {
              t('directionality', { processor: 'string', default: la.isRtl() ? 'rtl' : void 0 }), t('placeholder', { processor: 'string', default: zi.getAttrib(e.getElement(), 'placeholder') });
            });
        })(o);
      ...
      const l = pl(o);
      l && (oa.ScriptLoader._setReferrerPolicy(l), ta.DOM.styleSheetLoader._setReferrerPolicy(l)),
      ...
      d && (Nt.cacheSuffix = d.replace(/^[\?\&]+/, '')),
        (this.ui = { registry: pA(), styleSheetLoader: void 0, show: S, hide: S, setEnabled: S, isEnabled: L }),
        (this.mode = ((e) => {
          const t = ra('design'),
            n = ra({ design: { activate: S, deactivate: S, editorReadOnly: !1 }, readonly: { activate: S, deactivate: S, editorReadOnly: !0 } });
          return (
            ((e) => {
              e.serializer
                ? qR(e)
              ...
              set: (o) =>
                ((e, t, n, o) => {
                  if (o !== n.get()) {
                    ...
                    e.initialized ? lA(e, n, t, o) : e.on('init', () => lA(e, n, t, o));
                  }
                })(e, n.get(), t, o),
              get: () => t.get(),
              register: (e, t) => {
                n.set(
                  ((e, t, n) => {
                    if (j(iA, t)) throw new Error(`Cannot override default mode ${t}`);
                    return {
                      ...e,
                      [t]: {
                        ...n,
    ...
    render() {
      ((e) => {
        ...
        e.on('remove', () => {
          ...
          (e.ui.styleSheetLoader = ((e, t) => Jo.forElement(e, { contentCssCors: Gl(t), referrerPolicy: pl(t) }))(o, e)),
          zl(e) ? (e.inline = !0) : ((e.orgVisibility = e.getElement().style.visibility), (e.getElement().style.visibility = 'hidden'));
        const s = e.getElement().form || fR.getParent(t, 'form');
        s &&
          ((e.formElement = s),
            jl(e) && !No(e.getElement()) && (fR.insertAfter(fR.create('input', { type: 'hidden', name: t }), t), (e.hasHiddenInput = !0)),
            ...
            !Hl(e) || s.submit.nodeType || s.submit.length || s._mceOldSubmit || ((s._mceOldSubmit = s.submit), (s.submit = () => (e.editorManager.triggerSave(), e.setDirty(!1), s._mceOldSubmit(s))))),
    ...
    show() {
      const e = this;
      e.hidden && ((e.hidden = !1), e.inline ? (e.getBody().contentEditable = 'true') : (hA.show(e.getContainer()), hA.hide(e.id)), e.load(), e.dispatch('show'));
    }
    hide() {
      const e = this;
      e.hidden ||
        (e.save(),
          e.inline ? ((e.getBody().contentEditable = 'false'), e === e.editorManager.focusedEditor && (e.editorManager.focusedEditor = null)) : (hA.hide(e.getContainer()), hA.setStyle(e.id, 'display', e.orgDisplay)),
          (e.hidden = !0),
          e.dispatch('hide'));
    }
    isHidden() {
    ...
    save(e = {}) {
      ...
      const s = { ...o, content: r };
      if ((s.no_events || t.dispatch('SaveContent', s), 'raw' === s.format && t.dispatch('RawSaveContent', s), (r = s.content), No(n))) n.value = r;
      else {
    ...
    insertContent(e, t) {
      t && (e = bA({ content: e }, t)), this.execCommand('mceInsertContent', !1, e);
    }
    resetContent(e) {
      void 0 === e ? Vy(this, this.startContent, { format: 'raw' }) : Vy(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged();
    }
    isDirty() {
    ...
    getContainer() {
      const e = this;
      return e.container || (e.container = e.editorContainer || hA.get(e.id + '_parent')), e.container;
    }
    getContentAreaContainer() {
      return this.contentAreaContainer;
    }
    getElement() {
      return this.targetElm || (this.targetElm = hA.get(this.id)), this.targetElm;
    }
    getWin() {
      const e = this;
      if (!e.contentWindow) {
      ...
      ((e) => {
        if (!e.removed) {
          ...
          o && e.save({ is_removing: !0 }),
            ...
            e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && Yy.remove(r.nextSibling),
            ((e) => {
              e.dispatch('remove');
            })(e),
    ...
    destroy(e) {
      ((e, t) => {
        ...
        e.destroyed ||
          (t || e.removed
            ? (t || (e.editorManager.off('beforeunload', e._beforeUnload), e.theme && e.theme.destroy && e.theme.destroy(), Xy(n), Xy(o)),
              ((e) => {
                const t = e.formElement;
                t && (t._mceOldSubmit && ((t.submit = t._mceOldSubmit), delete t._mceOldSubmit), Yy.unbind(t, 'submit reset', e.formEventDelegate));
              })(e),
              ((e) => {
                const t = e;
  ...
  const _A = (e) => {
    ...
    EA = (e) => {
      if (e !== kA) {
        const t = ta.DOM;
        e ? (t.bind(window, 'resize', _A), t.bind(window, 'scroll', _A)) : (t.unbind(window, 'resize', _A), t.unbind(window, 'scroll', _A)), (kA = e);
      }
    },
    NA = (e) => {
      const t = SA;
      return (SA = K(SA, (t) => e !== t)), AA.activeEditor === e && (AA.activeEditor = SA.length > 0 ? SA[0] : null), AA.focusedEditor === e && (AA.focusedEditor = null), t.length !== SA.length;
    },
    ...
    AA = {
      ...
      setup() {
        ...
        var s;
        (e.baseURL = new qv(o).toAbsolute(t)), (e.documentBaseURL = o), (e.baseURI = new qv(e.baseURL)), (e.suffix = n), (s = e).on('AddEditor', O(Df, s)), s.on('RemoveEditor', O(Pf, s));
      },
      overrideDefaults(e) {
        const t = e.base_url;
      ...
      init(e) {
        ...
        const s = () => {
          ...
          CA.unbind(window, 'ready', s),
            ...
            (i = ((e, t) => {
              ...
              ((e) =>
                Nt.browser.isIE() || Nt.browser.isEdge()
                  ? (fC('TinyMCE does not support the browser you are using. For a list of supported browsers please see: https://www.tiny.cloud/docs/tinymce/6/support/#supportedwebbrowsers'), [])
                  : RA
                    ? (fC('Failed to initialize the editor as the document is not in standards mode. TinyMCE requires standards mode.'), [])
                    : m(e.selector)
            ...
            Tt.each(i, (e) => {
              var n;
              (n = t.get(e.id)) && n.initialized && !(n.getContainer() || n.getBody()).parentNode && (NA(n), n.unbindAllNativeEvents(), n.destroy(!0), (n.removed = !0));
            }),
            ...
            0 === i.length
              ...
              : wA(i, (s) => {
                ((e, t) => e.inline && t.tagName.toLowerCase() in o)(e, s)
                  ? fC('Could not initialize inline editor on invalid inline target element', s)
                  : ((e, o, s) => {
      ...
      get(e) {
        return 0 === arguments.length ? SA.slice(0) : m(e) ? Q(SA, (t) => t.id === e).getOr(null) : x(e) && SA[e] ? SA[e] : null;
      },
      add(e) {
        const t = this,
          n = t.get(e.id);
      ...
      remove(e) {
        ...
        let n;
        if (e) {
          if (!m(e)) return (n = e), h(t.get(n.id)) ? null : (NA(n) && t.dispatch('RemoveEditor', { editor: n }), 0 === SA.length && window.removeEventListener('beforeunload', xA), n.remove(), EA(SA.length > 0), n);
          wA(CA.select(e), (e) => {
      ...
      _setBaseUrl(e) {
        (this.baseURL = new qv(this.documentBaseURL).toAbsolute(e.replace(/\/+$/, ''))), (this.baseURI = new qv(this.baseURL));
      },
    };
  AA.setup();
  const OA = (() => {
    ...
    MA = {
      ...
      clamp: (e, t, n) => {
        ...
        const i = t.x + t.w,
          ...
          u = BA(0, s - i),
          m = BA(0, a - l);
        return (o += d), (r += c), n && ((s += d), (a += c), (o -= u), (r -= m)), (s -= u), (a -= m), LA(o, r, s - o, a - r);
      },
      create: LA,
  ...
  const UA = {
    ...
    dom: { EventUtils: qs, TreeWalker: Zo, TextSeeker: Ta, DOMUtils: ta, ScriptLoader: oa, RangeUtils: Ym, Serializer: $y, StyleSheetLoader: Qo, ControlSelection: xm, BookmarkManager: dm, Selection: zy, Event: qs.Event },
    html: { Styles: Ms, Entities: xs, Node: Zf, Schema: Ls, DomParser: Zv, Writer: ag, Serializer: ig },
    Env: Nt,
    AddOnManager: da,
    Annotator: lm,
    Formatter: DC,
...
//generate editor tinymce with selector jquery
  ...
  var init = $.extend(
    true,
    {
      ...
      plugins: ['advlist', 'autolink', 'lists', 'link', 'image',
        'charmap', 'preview', 'typography', 'blocks', 'blockquote',
        'anchor', 'searchreplace', 'visualblocks',
        'code', 'fullscreen', 'insertdatetime', 'media', 'table', 'help',
        'wordcount'],
      content_style:'../../bootstrap/css/bootstrap.min.css',
      toolbar: 'code undo redo typography blocks blockquote bold italic underline fontsize alignleft aligncenter alignright alignjustify outdent indent numlist bullist forecolor removeformat image table',
...
//generate editor tinymce with selector jquery
var editormini = function (select, options) {
  var init = $.extend(
    true,
    {
      selector: select,
      ...
      toolbar: 'alignleft aligncenter alignright alignjustify outdent indent numlist bullist',
      // content_css:'',
      automatic_uploads: true,
      file_picker_types: 'image',
      file_picker_callback: (cb, value, meta) => {
...
$(function () {
  ...
  editormini('textarea.contents-mini');
});
