...
var editor = function(select, options){
	var init = $.extend(true,{
		...
		convert_urls : false,
		plugins: [
			"preview fullscreen advlist autolink link image lists charmap  hr pagebreak",
			"wordcount visualblocks visualchars code media",
			"table contextmenu template textcolor paste textcolor filemanager",
		],
		add_unload_trigger: false,
		autosave_ask_before_unload: false,
		image_advtab: true, 
		toolbar1: "fullscreen preview code | bold italic underline strikethrough"
			+"alignleft aligncenter alignright alignjustify "
			+"bullist numlist outdent indent blockquote removeformat forecolor backcolor table hr | formatselect fontselect fontsizeselect | "
...
var editormini = function(select, options){
	var init = $.extend(true,{
		...
		toolbar1: "fullscreen preview code | bold italic underline strikethrough"
			+"alignleft aligncenter alignright alignjustify "
			+"bullist "// /*numlist outdent indent blockquote removeformat forecolor backcolor table hr */| 
